...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 959 | 🐛 29 | 🌐 Rust | 📅 2026-09-11
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 698 | 🐛 25 | 🌐 C# | 📅 2026-08-28
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 296 | 🐛 51 | 🌐 Go | 📅 2026-09-11
...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 10 | 🐛 0 | 🌐 PHP | 📅 2026-09-12
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,609 | 🐛 11 | 🌐 Python | 📅 2026-09-12 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,285 | 🐛 303 | 🌐 Python | 📅 2026-09-13 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,081 | 🐛 792 | 🌐 Rust | 📅 2026-09-13 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,879 | 🐛 210 | 🌐 Go | 📅 2026-09-13 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,297 | 🐛 57 | 🌐 Rust | 📅 2026-09-11 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,248 | 🐛 21 | 🌐 Go | 📅 2026-09-12 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 677 | 🐛 62 | 🌐 Go | 📅 2026-09-13 - Time-series data warehouse built on DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 19 | 🌐 HTML | 📅 2026-09-12 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,402 | 🐛 211 | 🌐 Python | 📅 2026-09-11 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,720 | 🐛 258 | 🌐 Python | 📅 2026-09-13 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 25 | 🌐 Python | 📅 2026-09-07 - A Python library for downloading and transforming raw OpenStreetMap data into GeoParquet files.
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-10 - Easy-to-use and high-performance JavaScript library for data analysis.
* [Vane](https://github.com/AstroVela/vane) ⭐ 129 | 🐛 166 | 🌐 Python | 📅 2026-09-13 - A multimodal-native engine for AI workloads, built on a DuckDB fork with Python and SQL interfaces.
...
* [jsqltranspiler](https://github.com/starlake-ai/jsqltranspiler) ⭐ 73 | 🐛 16 | 🌐 Java | 📅 2026-09-06 - Rewrite BigQuery, Redshift, Snowflake and Databricks queries into DuckDB-compatible SQL.
...
* [Preswald](https://github.com/StructuredLabs/preswald) ⭐ 4,273 | 🐛 330 | 🌐 Python | 📅 2026-06-11 - WASM packager for Python-based interactive data apps.
* [Medama](https://github.com/medama-io/medama) ⭐ 642 | 🐛 34 | 🌐 Go | 📅 2026-08-07 - Self-hostable, privacy-focused website analytics.
* [Duck-UI](https://github.com/caioricciuti/duck-ui) ⭐ 618 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-10 - Duck-UI is a web-based interface for interacting with DuckDB with a SQL editor, data import/export, data explorer, query history, theme toggle and keyboard shortcuts.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,328 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 688 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-13 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [AmoxSQL](https://github.com/DSandovalFlavio/AmoxSQL) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - The Modern Codex for Local Data Analysis. A high-performance, local-first IDE built specifically for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,062 | 🐛 36 | 🌐 Go | 📅 2026-09-12 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 500 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [Ducklings](https://github.com/tobilg/ducklings) ⭐ 260 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-19 - A minimal DuckDB WASM build for browsers and serverless environments like Cloudflare Workers.
...
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,959 | 🐛 19 | 🌐 Go | 📅 2026-09-11 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,762 | 🐛 112 | 🌐 Java | 📅 2026-09-11 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,703 | 🐛 57 | 🌐 Go | 📅 2026-09-11 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,350 | 🐛 86 | 🌐 Python | 📅 2026-09-08 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 797 | 🐛 61 | 🌐 Go | 📅 2026-09-13 - Enables SQL-based stream processing, powered by DuckDB.
* [metabase\_duckdb\_driver](https://github.com/MotherDuck-Open-Source/metabase_duckdb_driver) ⭐ 170 | 🐛 18 | 🌐 Clojure | 📅 2026-09-11 - Metabase DuckDB Driver shipped as 3rd party plugin.
* [xlDuckDb](https://github.com/RusselWebber/xlDuckDb) ⭐ 159 | 🐛 2 | 🌐 C# | 📅 2026-09-11 - Excel addin to run DuckDB queries in Excel.
* [kwack](https://github.com/rayokota/kwack) ⭐ 155 | 🐛 12 | 🌐 Java | 📅 2026-02-16 - In-Memory Analytics for Kafka using DuckDB.
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 120 | 🐛 15 | 🌐 Python | 📅 2026-09-13 - A semantic layer with DuckDB integration.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,637 | 🐛 110 | 🌐 Python | 📅 2026-09-11 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 366 | 🐛 2 | 🌐 C++ | 📅 2026-09-13 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,981 | 🐛 182 | 🌐 C++ | 📅 2026-09-10 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 435 | 🐛 82 | 🌐 C++ | 📅 2026-09-11 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 231 | 🐛 63 | 🌐 C++ | 📅 2026-09-11 - For Delta Lake support.
* [`azure`](https://github.com/duckdb/duckdb_azure) ⭐ 78 | 🐛 40 | 🌐 C++ | 📅 2026-08-12 - For using the Azure Blob storage.
* [`aws`](https://github.com/duckdb/duckdb_aws) ⭐ 65 | 🐛 37 | 🌐 C++ | 📅 2026-09-10 - For handling AWS credentials.
...
* [`yardstick`](https://github.com/sidequery/yardstick) ⭐ 58 | 🐛 1 | 🌐 Rust | 📅 2026-09-13 - Implements Measures in SQL paper as a DuckDB extension for centralized metric definitions / en embedded semantic layer.
...
* [duckdb\_engine](https://github.com/Mause/duckdb_engine) ⭐ 497 | 🐛 99 | 🌐 Python | 📅 2026-09-09 - SQLAlchemy driver for DuckDB.
...
* [UC Catalog Extension](https://github.com/duckdb/uc_catalog) ⭐ 110 | 🐛 39 | 🌐 C++ | 📅 2026-09-11 - Proof-of-concept extension combining the `delta` extension with Unity Catalog.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 2 | 🌐 Python | 📅 2026-09-13 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
