...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 971 | 🐛 30 | 🌐 Rust | 📅 2026-09-25
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 701 | 🐛 25 | 🌐 C# | 📅 2026-09-25
...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 12 | 🐛 0 | 🌐 PHP | 📅 2026-09-25
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,638 | 🐛 7 | 🌐 Python | 📅 2026-09-25 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,299 | 🐛 307 | 🌐 Python | 📅 2026-09-25 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,094 | 🐛 898 | 🌐 Rust | 📅 2026-09-25 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,914 | 🐛 198 | 🌐 Go | 📅 2026-09-25 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,326 | 🐛 65 | 🌐 Rust | 📅 2026-09-25 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,251 | 🐛 21 | 🌐 Go | 📅 2026-09-25 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 678 | 🐛 77 | 🌐 Go | 📅 2026-09-25 - Time-series data warehouse built on DuckDB.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 89 | 🐛 8 | 🌐 Go | 📅 2026-09-25 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,429 | 🐛 217 | 🌐 Python | 📅 2026-09-25 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,723 | 🐛 262 | 🌐 Python | 📅 2026-09-25 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [duckdb\_fdw](https://github.com/alitrack/duckdb_fdw) ⭐ 411 | 🐛 22 | 🌐 C | 📅 2026-09-25 - DuckDB Foreign Data Wrapper for PostgreSQL.
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 23 | 🌐 Python | 📅 2026-09-25 - A Python library for downloading and transforming raw OpenStreetMap data into GeoParquet files.
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-25 - Easy-to-use and high-performance JavaScript library for data analysis.
* [Vane](https://github.com/AstroVela/vane) ⭐ 135 | 🐛 186 | 🌐 Python | 📅 2026-09-25 - A multimodal-native engine for AI workloads, built on a DuckDB fork with Python and SQL interfaces.
* [flapi](https://github.com/DataZooDE/flapi) ⭐ 73 | 🐛 8 | 🌐 C++ | 📅 2026-09-25 - An API Framework that heavily relies on the power of DuckDB and DuckDB extensions. Ready to build performant and cost-efficient APIs on top of BigQuery or Snowflake for AI Agents and Data Apps.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,349 | 🐛 13 | 🌐 Rust | 📅 2026-09-24 - A database TUI with experimental support for DuckDB.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 887 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-25 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,071 | 🐛 61 | 🌐 Go | 📅 2026-09-25 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [SixSentences](https://github.com/SixSentences/sixsentences) ⭐ 6 | 🐛 79 | 🌐 Python | 📅 2026-09-25 - Self-hostable research workspace that compiles boolean literature-search queries to SQL and runs them offline with DuckDB over versioned Parquet snapshots of a scholarly corpus.
...
* [dlt-dbt-duckdb-evidence](https://github.com/Ddscully/dlt-dbt-duckdb-evidence) ⭐ 2 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - End-to-end pipeline over seven public data sources in a single DuckDB file, using dlt, dbt, Polars, Dagster and Evidence. Rebuilds from live sources on every push and publishes the DuckDB file and per-table Parquet monthly.
* [GTFS Scorecard](https://github.com/ChelseaKR/gtfs-scorecard) ⭐ 1 | 🐛 27 | 🌐 HTML | 📅 2026-09-25 - Data-quality grades for 2,400+ public transit (GTFS) feed records. DuckDB builds the cross-agency query layer and a public Parquet table that DuckDB can query over HTTP, and the site's SQL page runs DuckDB-WASM in the browser.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,772 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,977 | 🐛 20 | 🌐 Go | 📅 2026-09-25 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,743 | 🐛 61 | 🌐 Go | 📅 2026-09-25 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,358 | 🐛 87 | 🌐 Python | 📅 2026-09-21 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 799 | 🐛 78 | 🌐 Go | 📅 2026-09-25 - Enables SQL-based stream processing, powered by DuckDB.
...
* [omniload](https://github.com/panodata/omniload) ⭐ 5 | 🐛 42 | 🌐 Python | 📅 2026-09-25 - Polyglot data loader for ETL, warehousing and more, based on dlt. Supports 140+ source/destination adapters. Derived from ingestr v0 (MIT).
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,644 | 🐛 110 | 🌐 Python | 📅 2026-09-25 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 3,004 | 🐛 186 | 🌐 C++ | 📅 2026-09-25 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 441 | 🐛 79 | 🌐 C++ | 📅 2026-09-25 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 231 | 🐛 62 | 🌐 C++ | 📅 2026-09-25 - For Delta Lake support.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 499 | 🐛 32 | 🌐 C++ | 📅 2026-09-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`bigquery`](https://github.com/hafenkran/duckdb-bigquery) ⭐ 171 | 🐛 8 | 🌐 C++ | 📅 2026-09-25 - Integrates DuckDB with Google BigQuery, allowing direct querying and management of BigQuery datasets.
...
* [`duckherder`](https://github.com/dentiny/duckdb-distributed-execution) ⭐ 64 | 🐛 15 | 🌐 C++ | 📅 2026-09-25 - Distributed execution for DuckDB queries.
...
* [FlockMTL](https://github.com/dsg-polymtl/flockmtl) ⭐ 359 | 🐛 29 | 🌐 C++ | 📅 2026-09-25 - Integrate language model (LLM) capabilities directly into your queries and workflows.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 5 | 🌐 C++ | 📅 2026-09-25 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 1 | 🌐 Python | 📅 2026-09-25 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
