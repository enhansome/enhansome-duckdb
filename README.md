...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,606 | 🐛 4 | 🌐 Python | 📅 2026-09-12 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,282 | 🐛 302 | 🌐 Python | 📅 2026-09-12 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,080 | 🐛 800 | 🌐 Rust | 📅 2026-09-12 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,296 | 🐛 56 | 🌐 Rust | 📅 2026-09-11 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
...
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 677 | 🐛 55 | 🌐 Go | 📅 2026-09-12 - Time-series data warehouse built on DuckDB.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 5,007 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,399 | 🐛 211 | 🌐 Python | 📅 2026-09-11 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,720 | 🐛 256 | 🌐 Python | 📅 2026-09-12 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [Vane](https://github.com/AstroVela/vane) ⭐ 129 | 🐛 167 | 🌐 Python | 📅 2026-09-12 - A multimodal-native engine for AI workloads, built on a DuckDB fork with Python and SQL interfaces.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,326 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 665 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-12 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,061 | 🐛 36 | 🌐 Go | 📅 2026-09-12 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 499 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,731 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,957 | 🐛 19 | 🌐 Go | 📅 2026-09-11 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,763 | 🐛 112 | 🌐 Java | 📅 2026-09-11 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
...
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 797 | 🐛 59 | 🌐 Go | 📅 2026-09-12 - Enables SQL-based stream processing, powered by DuckDB.
...
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 588 | 🐛 39 | 🌐 Go | 📅 2026-09-12 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 364 | 🐛 2 | 🌐 C++ | 📅 2026-09-12 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,980 | 🐛 178 | 🌐 C++ | 📅 2026-09-10 - For DuckLake support.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 6 | 🌐 C++ | 📅 2026-09-12 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 2 | 🌐 Python | 📅 2026-09-12 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
