...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 962 | 🐛 29 | 🌐 Rust | 📅 2026-09-14
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 698 | 🐛 25 | 🌐 C# | 📅 2026-08-28
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 296 | 🐛 49 | 🌐 Go | 📅 2026-09-11
...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 11 | 🐛 0 | 🌐 PHP | 📅 2026-09-12
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,614 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,288 | 🐛 308 | 🌐 Python | 📅 2026-09-14 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,080 | 🐛 799 | 🌐 Rust | 📅 2026-09-14 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,882 | 🐛 210 | 🌐 Go | 📅 2026-09-14 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,297 | 🐛 58 | 🌐 Rust | 📅 2026-09-11 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,248 | 🐛 21 | 🌐 Go | 📅 2026-09-14 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 677 | 🐛 62 | 🌐 Go | 📅 2026-09-14 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 614 | 🐛 116 | 🌐 JavaScript | 📅 2026-09-08 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 88 | 🐛 19 | 🌐 Go | 📅 2026-09-12 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 19 | 🌐 HTML | 📅 2026-09-14 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
* [DataCharter](https://github.com/datacharter/datacharter) ⭐ 12 | 🐛 10 | 🌐 Python | 📅 2026-09-09 - Local, contract-governed data explorer. Federates files and databases (Postgres, Snowflake, BigQuery, Excel, and more) through DuckDB — SQL editor, charts, profiling — then hands AI agents a PII-masked, read-only query surface over MCP. Apache-2.0.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 5,009 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,408 | 🐛 212 | 🌐 Python | 📅 2026-09-14 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,720 | 🐛 256 | 🌐 Python | 📅 2026-09-14 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 532 | 🐛 23 | 🌐 Python | 📅 2026-09-10 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
* [duckdb\_fdw](https://github.com/alitrack/duckdb_fdw) ⭐ 409 | 🐛 23 | 🌐 C | 📅 2026-05-29 - DuckDB Foreign Data Wrapper for PostgreSQL.
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 24 | 🌐 Python | 📅 2026-09-07 - A Python library for downloading and transforming raw OpenStreetMap data into GeoParquet files.
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-14 - Easy-to-use and high-performance JavaScript library for data analysis.
* [Vane](https://github.com/AstroVela/vane) ⭐ 130 | 🐛 164 | 🌐 Python | 📅 2026-09-14 - A multimodal-native engine for AI workloads, built on a DuckDB fork with Python and SQL interfaces.
* [flapi](https://github.com/DataZooDE/flapi) ⭐ 73 | 🐛 1 | 🌐 C++ | 📅 2026-09-13 - An API Framework that heavily relies on the power of DuckDB and DuckDB extensions. Ready to build performant and cost-efficient APIs on top of BigQuery or Snowflake for AI Agents and Data Apps.
...
* [Preswald](https://github.com/StructuredLabs/preswald) ⭐ 4,271 | 🐛 330 | 🌐 Python | 📅 2026-06-11 - WASM packager for Python-based interactive data apps.
...
* [DuckQuery](https://github.com/Chenkeliang/duckdb-query) ⭐ 44 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 - Open-source visual SQL workbench to query local files (CSV/Excel/Parquet/JSON) and remote databases (MySQL/PostgreSQL) in one cross-source JOIN, plus AI text-to-SQL. Browser demo runs on DuckDB-Wasm; the full version self-hosts via Docker.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,330 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 721 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-14 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [AmoxSQL](https://github.com/DSandovalFlavio/AmoxSQL) ⭐ 13 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14 - The Modern Codex for Local Data Analysis. A high-performance, local-first IDE built specifically for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,062 | 🐛 38 | 🌐 Go | 📅 2026-09-14 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 501 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [duckdb-embedding-search](https://github.com/patricktrainer/duckdb-embedding-search) ⭐ 151 | 🐛 4 | 🌐 Python | 📅 2024-10-30 - A search engine for DuckDB that uses embedding vectors to find similar documents.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,732 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,962 | 🐛 22 | 🌐 Go | 📅 2026-09-14 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,761 | 🐛 112 | 🌐 Java | 📅 2026-09-11 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,706 | 🐛 58 | 🌐 Go | 📅 2026-09-14 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,350 | 🐛 86 | 🌐 Python | 📅 2026-09-14 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 797 | 🐛 47 | 🌐 Go | 📅 2026-09-14 - Enables SQL-based stream processing, powered by DuckDB.
* [metabase\_duckdb\_driver](https://github.com/MotherDuck-Open-Source/metabase_duckdb_driver) ⭐ 170 | 🐛 19 | 🌐 Clojure | 📅 2026-09-14 - Metabase DuckDB Driver shipped as 3rd party plugin.
* [xlDuckDb](https://github.com/RusselWebber/xlDuckDb) ⭐ 162 | 🐛 2 | 🌐 C# | 📅 2026-09-11 - Excel addin to run DuckDB queries in Excel.
* [kwack](https://github.com/rayokota/kwack) ⭐ 155 | 🐛 12 | 🌐 Java | 📅 2026-02-16 - In-Memory Analytics for Kafka using DuckDB.
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 120 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - A semantic layer with DuckDB integration.
...
* [DuckDBExcelAddin](https://github.com/sonhn85/DuckDBExcelAddin) ⭐ 3 | 🐛 1 | 🌐 C | 📅 2026-09-12 - Native Excel XLL add-in for DuckDB with parameter binding, async execution and Excel range table functions.
...
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,235 | 🐛 125 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
* [pg\_mooncake](https://github.com/Mooncake-Labs/pg_mooncake) ⭐ 2,005 | 🐛 14 | 🌐 Rust | 📅 2026-03-31 - A PostgreSQL extension that adds native column store tables with DuckDB.
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,638 | 🐛 110 | 🌐 Python | 📅 2026-09-14 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 366 | 🐛 2 | 🌐 C++ | 📅 2026-09-14 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,983 | 🐛 177 | 🌐 C++ | 📅 2026-09-14 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 435 | 🐛 84 | 🌐 C++ | 📅 2026-09-14 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 231 | 🐛 67 | 🌐 C++ | 📅 2026-09-14 - For Delta Lake support.
* [`azure`](https://github.com/duckdb/duckdb_azure) ⭐ 78 | 🐛 39 | 🌐 C++ | 📅 2026-09-14 - For using the Azure Blob storage.
* [`aws`](https://github.com/duckdb/duckdb_aws) ⭐ 65 | 🐛 38 | 🌐 C++ | 📅 2026-09-10 - For handling AWS credentials.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 491 | 🐛 32 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
* [`gsheets`](https://github.com/evidence-dev/duckdb_gsheets) ⭐ 353 | 🐛 11 | 🌐 C++ | 📅 2026-02-21 - Read and write Google Sheets using SQL.
...
* [`h3`](https://github.com/isaacbrodsky/h3-duckdb) ⭐ 252 | 🐛 14 | 🌐 C | 📅 2026-07-22 - Adds support for the H3 discrete global grid system.
...
* [FlockMTL](https://github.com/dsg-polymtl/flockmtl) ⭐ 356 | 🐛 26 | 🌐 C++ | 📅 2026-07-26 - Integrate language model (LLM) capabilities directly into your queries and workflows.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 2 | 🌐 C++ | 📅 2026-09-13 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
