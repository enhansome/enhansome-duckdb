...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 10 | 🐛 0 | 🌐 PHP | 📅 2026-09-06
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,592 | 🐛 6 | 🌐 Python | 📅 2026-09-05 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,277 | 🐛 286 | 🌐 Python | 📅 2026-09-05 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,077 | 🐛 808 | 🌐 Rust | 📅 2026-09-06 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,867 | 🐛 213 | 🌐 Go | 📅 2026-09-05 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,271 | 🐛 58 | 🌐 Rust | 📅 2026-09-05 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,248 | 🐛 21 | 🌐 Go | 📅 2026-09-05 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 675 | 🐛 47 | 🌐 Go | 📅 2026-09-04 - Time-series data warehouse built on DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 20 | 🌐 HTML | 📅 2026-09-06 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,385 | 🐛 210 | 🌐 Python | 📅 2026-09-04 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,715 | 🐛 264 | 🌐 Python | 📅 2026-09-06 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 533 | 🐛 23 | 🌐 Python | 📅 2026-09-06 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,322 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
...
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 426 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-06 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [AmoxSQL](https://github.com/DSandovalFlavio/AmoxSQL) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-06 - The Modern Codex for Local Data Analysis. A high-performance, local-first IDE built specifically for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,056 | 🐛 58 | 🌐 Go | 📅 2026-09-06 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 495 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,702 | 🐛 6 | 🌐 Makefile | 📅 2026-09-04 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,947 | 🐛 23 | 🌐 Go | 📅 2026-09-05 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,696 | 🐛 59 | 🌐 Go | 📅 2026-09-06 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,347 | 🐛 85 | 🌐 Python | 📅 2026-09-04 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 793 | 🐛 59 | 🌐 Go | 📅 2026-09-06 - Enables SQL-based stream processing, powered by DuckDB.
...
* [xlDuckDb](https://github.com/RusselWebber/xlDuckDb) ⭐ 152 | 🐛 1 | 🌐 C# | 📅 2026-09-05 - Excel addin to run DuckDB queries in Excel.
...
* [DuckDBExcelAddin](https://github.com/sonhn85/DuckDBExcelAddin) ⭐ 2 | 🐛 2 | 🌐 C | 📅 2026-09-06 - Native Excel XLL add-in for DuckDB with parameter binding, async execution and Excel range table functions.
...
* [AliSQL](https://github.com/alibaba/AliSQL) ⭐ 5,931 | 🐛 15 | 🌐 C++ | 📅 2026-07-18 - A MySQL branch originated from Alibaba Group. Integrates DuckDB as a native storage engine.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,636 | 🐛 102 | 🌐 Python | 📅 2026-09-06 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 587 | 🐛 39 | 🌐 Go | 📅 2026-09-06 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [Porter](https://github.com/TFMV/porter) ⭐ 149 | 🐛 5 | 🌐 Go | 📅 2026-09-02 - A Go-based implementation of a DuckDB Arrow Flight SQL Server.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,963 | 🐛 178 | 🌐 C++ | 📅 2026-09-04 - For DuckLake support.
...
* [`inet`](https://github.com/duckdb/duckdb_inet) ⭐ 13 | 🐛 13 | 🌐 C++ | 📅 2025-11-20 - For storing and handling IPv4 and IPv6 Internet addresses.
...
* [UC Catalog Extension](https://github.com/duckdb/uc_catalog) ⭐ 109 | 🐛 37 | 🌐 C++ | 📅 2026-09-04 - Proof-of-concept extension combining the `delta` extension with Unity Catalog.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 1 | 🌐 Python | 📅 2026-09-06 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
