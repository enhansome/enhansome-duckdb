...
* [Awesome DuckLake](https://github.com/esadek/awesome-ducklake) ⭐ 143 | 🐛 5 | 📅 2026-04-20 - A curated list of awesome DuckLake tools and resources.
...
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 285 | 🐛 54 | 🌐 Go | 📅 2026-08-12
...
* [Haskell](https://github.com/Tritlo/duckdb-haskell) ⭐ 22 | 🐛 4 | 🌐 Haskell | 📅 2026-08-18
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,546 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,246 | 🐛 266 | 🌐 Python | 📅 2026-08-18 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,069 | 🐛 638 | 🌐 Rust | 📅 2026-08-19 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,817 | 🐛 199 | 🌐 Go | 📅 2026-08-19 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,232 | 🐛 21 | 🌐 Go | 📅 2026-08-19 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,161 | 🐛 60 | 🌐 Rust | 📅 2026-08-19 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 663 | 🐛 45 | 🌐 Go | 📅 2026-08-19 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 607 | 🐛 112 | 🌐 JavaScript | 📅 2026-08-14 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 82 | 🐛 6 | 🌐 Go | 📅 2026-08-19 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
* [Whereabouts](https://github.com/ajl2718/whereabouts) ⭐ 79 | 🐛 15 | 🌐 Python | 📅 2026-08-10 - Fast, accurate, open-source geocoding in Python, using DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 21 | 🌐 HTML | 📅 2026-08-19 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Pondview](https://github.com/paulmupeters/pondview-bi) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - Open-source, DuckDB-powered BI workspace for AI-assisted analysis, SQL, charts, and dashboards.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 4,995 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,346 | 🐛 225 | 🌐 Python | 📅 2026-08-19 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,700 | 🐛 256 | 🌐 Python | 📅 2026-08-19 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 528 | 🐛 21 | 🌐 Python | 📅 2026-08-19 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-19 - Easy-to-use and high-performance JavaScript library for data analysis.
...
* [DuckDB.EFCoreProvider](https://github.com/skuirrels/DuckDB.EFCoreProvider) ⭐ 14 | 🐛 2 | 🌐 C# | 📅 2026-08-19 - Entity Framework Core provider for DuckDB and DuckLake, with LINQ, writes, migrations, bulk ingestion, and Parquet-backed tiered storage for .NET.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,283 | 🐛 19 | 🌐 Rust | 📅 2026-08-17 - A database TUI with experimental support for DuckDB.
* [Duckling](https://github.com/l1xnan/duckling) ⭐ 575 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-13 - A fast viewer for CSV/Parquet files and DuckDB/SQLite, based on Tauri.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,024 | 🐛 99 | 🌐 Go | 📅 2026-08-19 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [Ducklings](https://github.com/tobilg/ducklings) ⭐ 250 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19 - A minimal DuckDB WASM build for browsers and serverless environments like Cloudflare Workers.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,610 | 🐛 2 | 🌐 Makefile | 📅 2026-08-13 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,760 | 🐛 110 | 🌐 Java | 📅 2026-08-19 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,336 | 🐛 83 | 🌐 Python | 📅 2026-08-17 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 789 | 🐛 33 | 🌐 Python | 📅 2025-09-04 - Enables SQL-based stream processing, powered by DuckDB.
* [metabase\_duckdb\_driver](https://github.com/MotherDuck-Open-Source/metabase_duckdb_driver) ⭐ 167 | 🐛 19 | 🌐 Clojure | 📅 2026-08-18 - Metabase DuckDB Driver shipped as 3rd party plugin.
...
* [DuckDBExcelAddin](https://github.com/sonhn85/DuckDBExcelAddin) ⭐ 1 | 🐛 0 | 🌐 C | 📅 2026-08-17 - Native Excel XLL add-in for DuckDB with parameter binding, async execution and Excel range table functions.
...
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,198 | 🐛 115 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
* [pg\_mooncake](https://github.com/Mooncake-Labs/pg_mooncake) ⭐ 2,001 | 🐛 14 | 🌐 Rust | 📅 2026-03-31 - A PostgreSQL extension that adds native column store tables with DuckDB.
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,618 | 🐛 108 | 🌐 Python | 📅 2026-08-19 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 582 | 🐛 36 | 🌐 Go | 📅 2026-08-19 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,923 | 🐛 166 | 🌐 C++ | 📅 2026-08-18 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 427 | 🐛 80 | 🌐 C++ | 📅 2026-08-19 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 228 | 🐛 62 | 🌐 C++ | 📅 2026-08-19 - For Delta Lake support.
...
* [`cache_httpfs`](https://github.com/dentiny/duck-read-cache-fs) ⭐ 144 | 🐛 13 | 🌐 C++ | 📅 2026-08-06 - Adds a read caching layer to duckdb filesystem to improve query performance and reduce egress cost.
* [`infera`](https://github.com/CogitatorTech/infera) ⭐ 135 | 🐛 5 | 🌐 Rust | 📅 2026-07-22 - A DuckDB extension for in-database inference.
* [`dash`](https://github.com/gropaul/dash) ⭐ 96 | 🐛 1 | 🌐 C++ | 📅 2026-08-13 - Fully local data canvas and dashboarding app within DuckDB.
...
* [FlockMTL](https://github.com/dsg-polymtl/flockmtl) ⭐ 354 | 🐛 26 | 🌐 C++ | 📅 2026-07-26 - Integrate language model (LLM) capabilities directly into your queries and workflows.
* [UC Catalog Extension](https://github.com/duckdb/uc_catalog) ⭐ 108 | 🐛 33 | 🌐 C++ | 📅 2026-08-14 - Proof-of-concept extension combining the `delta` extension with Unity Catalog.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
