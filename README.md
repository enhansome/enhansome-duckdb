...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 965 | 🐛 29 | 🌐 Rust | 📅 2026-09-18
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 701 | 🐛 25 | 🌐 C# | 📅 2026-08-28
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,626 | 🐛 7 | 🌐 Python | 📅 2026-09-18 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,292 | 🐛 304 | 🌐 Python | 📅 2026-09-16 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,083 | 🐛 840 | 🌐 Rust | 📅 2026-09-18 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,898 | 🐛 203 | 🌐 Go | 📅 2026-09-18 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,308 | 🐛 61 | 🌐 Rust | 📅 2026-09-18 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,250 | 🐛 24 | 🌐 Go | 📅 2026-09-18 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 676 | 🐛 57 | 🌐 Go | 📅 2026-09-17 - Time-series data warehouse built on DuckDB.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 89 | 🐛 22 | 🌐 Go | 📅 2026-09-15 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 11 | 🐛 21 | 🌐 HTML | 📅 2026-09-18 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,413 | 🐛 211 | 🌐 Python | 📅 2026-09-18 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,721 | 🐛 264 | 🌐 Python | 📅 2026-09-18 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [Vane](https://github.com/AstroVela/vane) ⭐ 132 | 🐛 177 | 🌐 Python | 📅 2026-09-18 - A multimodal-native engine for AI workloads, built on a DuckDB fork with Python and SQL interfaces.
* [flapi](https://github.com/DataZooDE/flapi) ⭐ 73 | 🐛 4 | 🌐 C++ | 📅 2026-09-18 - An API Framework that heavily relies on the power of DuckDB and DuckDB extensions. Ready to build performant and cost-efficient APIs on top of BigQuery or Snowflake for AI Agents and Data Apps.
...
* [Preswald](https://github.com/StructuredLabs/preswald) ⭐ 4,270 | 🐛 330 | 🌐 Python | 📅 2026-06-11 - WASM packager for Python-based interactive data apps.
...
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 800 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-18 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
* [Duckling](https://github.com/l1xnan/duckling) ⭐ 581 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-17 - A fast viewer for CSV/Parquet files and DuckDB/SQLite, based on Tauri.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,065 | 🐛 45 | 🌐 Go | 📅 2026-09-18 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 504 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,749 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,709 | 🐛 60 | 🌐 Go | 📅 2026-09-17 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,353 | 🐛 85 | 🌐 Python | 📅 2026-09-18 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 798 | 🐛 74 | 🌐 Go | 📅 2026-09-18 - Enables SQL-based stream processing, powered by DuckDB.
...
* [xlDuckDb](https://github.com/RusselWebber/xlDuckDb) ⭐ 164 | 🐛 1 | 🌐 C# | 📅 2026-09-11 - Excel addin to run DuckDB queries in Excel.
* [kwack](https://github.com/rayokota/kwack) ⭐ 155 | 🐛 12 | 🌐 Java | 📅 2026-02-16 - In-Memory Analytics for Kafka using DuckDB.
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 121 | 🐛 5 | 🌐 Python | 📅 2026-09-18 - A semantic layer with DuckDB integration.
...
* [DuckDBExcelAddin](https://github.com/sonhn85/DuckDBExcelAddin) ⭐ 5 | 🐛 1 | 🌐 C | 📅 2026-09-18 - Native Excel XLL add-in for DuckDB with parameter binding, async execution and Excel range table functions.
...
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 590 | 🐛 45 | 🌐 Go | 📅 2026-09-18 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 367 | 🐛 1 | 🌐 C++ | 📅 2026-09-15 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,991 | 🐛 172 | 🌐 C++ | 📅 2026-09-18 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 438 | 🐛 82 | 🌐 C++ | 📅 2026-09-18 - For reading Iceberg tables.
...
* [`gpudb`](https://github.com/singhpratech/duckdbgpumetaldbram) ⭐ 24 | 🐛 2 | 🌐 C++ | 📅 2026-09-18 - GPU-accelerated aggregates, GROUP BY and hash joins on NVIDIA CUDA and Apple Silicon Metal, with GPU-resident columns for repeated queries.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 1 | 🌐 C++ | 📅 2026-09-18 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
