...
* [DuckDB AWS Lambda layer (Python)](https://github.com/bengeois/aws-layer-duckdb-python) ⭐ 14 | 🐛 5 | 🌐 Python | 📅 2026-09-01 - Run DuckDB in AWS Lambda functions using Python.
...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 959 | 🐛 25 | 🌐 Rust | 📅 2026-08-31
...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 9 | 🐛 0 | 🌐 PHP | 📅 2026-09-01
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,585 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,264 | 🐛 273 | 🌐 Python | 📅 2026-09-01 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,074 | 🐛 765 | 🌐 Rust | 📅 2026-09-01 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,859 | 🐛 209 | 🌐 Go | 📅 2026-09-01 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,257 | 🐛 69 | 🌐 Rust | 📅 2026-09-01 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
...
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 672 | 🐛 54 | 🌐 Go | 📅 2026-09-01 - Time-series data warehouse built on DuckDB.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 84 | 🐛 13 | 🌐 Go | 📅 2026-09-01 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,373 | 🐛 218 | 🌐 Python | 📅 2026-09-01 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,713 | 🐛 251 | 🌐 Python | 📅 2026-09-01 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 533 | 🐛 21 | 🌐 Python | 📅 2026-09-01 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-01 - Easy-to-use and high-performance JavaScript library for data analysis.
* [flapi](https://github.com/DataZooDE/flapi) ⭐ 73 | 🐛 1 | 🌐 C++ | 📅 2026-09-01 - An API Framework that heavily relies on the power of DuckDB and DuckDB extensions. Ready to build performant and cost-efficient APIs on top of BigQuery or Snowflake for AI Agents and Data Apps.
...
* [DuckQuery](https://github.com/Chenkeliang/duckdb-query) ⭐ 42 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-03 - Open-source visual SQL workbench to query local files (CSV/Excel/Parquet/JSON) and remote databases (MySQL/PostgreSQL) in one cross-source JOIN, plus AI text-to-SQL. Browser demo runs on DuckDB-Wasm; the full version self-hosts via Docker.
...
* [Duckling](https://github.com/l1xnan/duckling) ⭐ 577 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-01 - A fast viewer for CSV/Parquet files and DuckDB/SQLite, based on Tauri.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,047 | 🐛 89 | 🌐 Go | 📅 2026-09-01 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 491 | 🐛 52 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [Ducklings](https://github.com/tobilg/ducklings) ⭐ 257 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19 - A minimal DuckDB WASM build for browsers and serverless environments like Cloudflare Workers.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,679 | 🐛 4 | 🌐 Makefile | 📅 2026-08-21 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,932 | 🐛 26 | 🌐 Go | 📅 2026-09-01 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,682 | 🐛 56 | 🌐 Go | 📅 2026-09-01 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,345 | 🐛 85 | 🌐 Python | 📅 2026-08-31 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 792 | 🐛 31 | 🌐 Go | 📅 2026-09-01 - Enables SQL-based stream processing, powered by DuckDB.
...
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 117 | 🐛 7 | 🌐 Python | 📅 2026-09-01 - A semantic layer with DuckDB integration.
...
* [AliSQL](https://github.com/alibaba/AliSQL) ⭐ 5,887 | 🐛 12 | 🌐 C++ | 📅 2026-07-18 - A MySQL branch originated from Alibaba Group. Integrates DuckDB as a native storage engine.
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,221 | 🐛 123 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,630 | 🐛 111 | 🌐 Python | 📅 2026-09-01 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,954 | 🐛 176 | 🌐 C++ | 📅 2026-09-01 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 434 | 🐛 74 | 🌐 C++ | 📅 2026-09-01 - For reading Iceberg tables.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 486 | 🐛 32 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`crypto`](https://github.com/rustyconover/duckdb-crypto-extension) ⭐ 31 | 🐛 1 | 🌐 C++ | 📅 2026-08-30 - Cryptographic hash functions and HMAC.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
