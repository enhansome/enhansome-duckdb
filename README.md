...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 954 | 🐛 21 | 🌐 Rust | 📅 2026-08-17
...
* [Haskell](https://github.com/Tritlo/duckdb-haskell) ⭐ 22 | 🐛 5 | 🌐 Haskell | 📅 2026-08-18
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 8 | 🐛 0 | 🌐 PHP | 📅 2026-08-18
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,540 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,244 | 🐛 267 | 🌐 Python | 📅 2026-08-17 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,068 | 🐛 640 | 🌐 Rust | 📅 2026-08-18 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,816 | 🐛 198 | 🌐 Go | 📅 2026-08-18 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
* [Amphi ETL](https://github.com/amphi-ai/amphi-etl) ⭐ 1,397 | 🐛 128 | 🌐 TypeScript | 📅 2026-07-23 - Low-code data pipelines for structured and unstructured data. SQL transformations are powered by DuckDB.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,222 | 🐛 25 | 🌐 Go | 📅 2026-08-18 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,154 | 🐛 57 | 🌐 Rust | 📅 2026-08-18 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 659 | 🐛 40 | 🌐 Go | 📅 2026-08-18 - Time-series data warehouse built on DuckDB.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 82 | 🐛 6 | 🌐 Go | 📅 2026-08-18 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 21 | 🌐 HTML | 📅 2026-08-18 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
* [DataCharter](https://github.com/datacharter/datacharter) ⭐ 11 | 🐛 9 | 🌐 Python | 📅 2026-08-13 - Local, contract-governed data explorer. Federates files and databases (Postgres, Snowflake, BigQuery, Excel, and more) through DuckDB — SQL editor, charts, profiling — then hands AI agents a PII-masked, read-only query surface over MCP. Apache-2.0.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 4,991 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,700 | 🐛 259 | 🌐 Python | 📅 2026-08-18 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 528 | 🐛 21 | 🌐 Python | 📅 2026-08-17 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,279 | 🐛 19 | 🌐 Rust | 📅 2026-08-17 - A database TUI with experimental support for DuckDB.
...
* [tuitab](https://github.com/denisotree/tuitab) ⭐ 27 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - A Rust TUI for fast, in-depth analytics on large datasets (CSV, JSON, Parquet, Excel, SQLite) powered by DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,020 | 🐛 102 | 🌐 Go | 📅 2026-08-18 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,604 | 🐛 2 | 🌐 Makefile | 📅 2026-08-13 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
...
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 114 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - A semantic layer with DuckDB integration.
...
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,197 | 🐛 115 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
* [pg\_mooncake](https://github.com/Mooncake-Labs/pg_mooncake) ⭐ 2,000 | 🐛 14 | 🌐 Rust | 📅 2026-03-31 - A PostgreSQL extension that adds native column store tables with DuckDB.
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,617 | 🐛 106 | 🌐 Python | 📅 2026-08-18 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,919 | 🐛 164 | 🌐 C++ | 📅 2026-08-18 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 426 | 🐛 80 | 🌐 C++ | 📅 2026-08-18 - For reading Iceberg tables.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 477 | 🐛 30 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`dash`](https://github.com/gropaul/dash) ⭐ 95 | 🐛 1 | 🌐 C++ | 📅 2026-08-13 - Fully local data canvas and dashboarding app within DuckDB.
...
* [`stats_duck`](https://github.com/KoliStat/the-stats-duck) ⭐ 56 | 🐛 18 | 🌐 C++ | 📅 2026-08-14 - Statistics for tabular and clinical data: descriptive tables (`table_one`), linear models with robust/clustered standard errors, meta-analysis, bootstrap, and a grammar-of-graphics `VISUALIZE` clause that turns queries into Vega-Lite charts.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-08-18 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
