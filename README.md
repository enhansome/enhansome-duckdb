...
* Third-party installation options. Note: these are not maintained by the core DuckDB team – proceed with caution.
  * [DuckDB version manager (`duckman`)](https://github.com/NiclasHaderer/duckdb-version-manager) ⭐ 37 | 🐛 0 | 🌐 Go | 📅 2026-09-03 – Cross-platform installer and version manager for DuckDB.
...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 960 | 🐛 29 | 🌐 Rust | 📅 2026-09-09
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 698 | 🐛 25 | 🌐 C# | 📅 2026-08-28
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 294 | 🐛 52 | 🌐 Go | 📅 2026-09-08
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,600 | 🐛 9 | 🌐 Python | 📅 2026-09-09 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,281 | 🐛 290 | 🌐 Python | 📅 2026-09-09 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,080 | 🐛 791 | 🌐 Rust | 📅 2026-09-09 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,873 | 🐛 214 | 🌐 Go | 📅 2026-09-09 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,248 | 🐛 21 | 🌐 Go | 📅 2026-09-08 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 676 | 🐛 45 | 🌐 Go | 📅 2026-09-08 - Time-series data warehouse built on DuckDB.
...
* [Tailpipe](https://github.com/turbot/tailpipe) ⭐ 580 | 🐛 39 | 🌐 Go | 📅 2026-09-09 - An open-source SIEM for instant log insights.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 86 | 🐛 9 | 🌐 Go | 📅 2026-09-04 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 19 | 🌐 HTML | 📅 2026-09-08 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,392 | 🐛 207 | 🌐 Python | 📅 2026-09-09 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,717 | 🐛 261 | 🌐 Python | 📅 2026-09-09 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 533 | 🐛 23 | 🌐 Python | 📅 2026-09-09 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-09 - Easy-to-use and high-performance JavaScript library for data analysis.
...
* [Duck-UI](https://github.com/caioricciuti/duck-ui) ⭐ 615 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-03 - Duck-UI is a web-based interface for interacting with DuckDB with a SQL editor, data import/export, data explorer, query history, theme toggle and keyboard shortcuts.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,323 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
...
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 475 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-09 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,059 | 🐛 44 | 🌐 Go | 📅 2026-09-09 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [Ducklings](https://github.com/tobilg/ducklings) ⭐ 258 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19 - A minimal DuckDB WASM build for browsers and serverless environments like Cloudflare Workers.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,721 | 🐛 6 | 🌐 Makefile | 📅 2026-09-09 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,952 | 🐛 23 | 🌐 Go | 📅 2026-09-09 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,763 | 🐛 111 | 🌐 Java | 📅 2026-09-09 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,702 | 🐛 62 | 🌐 Go | 📅 2026-09-09 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,349 | 🐛 86 | 🌐 Python | 📅 2026-09-08 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 795 | 🐛 62 | 🌐 Go | 📅 2026-09-09 - Enables SQL-based stream processing, powered by DuckDB.
...
* [xlDuckDb](https://github.com/RusselWebber/xlDuckDb) ⭐ 155 | 🐛 2 | 🌐 C# | 📅 2026-09-05 - Excel addin to run DuckDB queries in Excel.
...
* [DuckDBExcelAddin](https://github.com/sonhn85/DuckDBExcelAddin) ⭐ 2 | 🐛 2 | 🌐 C | 📅 2026-09-09 - Native Excel XLL add-in for DuckDB with parameter binding, async execution and Excel range table functions.
...
* [AliSQL](https://github.com/alibaba/AliSQL) ⭐ 5,973 | 🐛 15 | 🌐 C++ | 📅 2026-07-18 - A MySQL branch originated from Alibaba Group. Integrates DuckDB as a native storage engine.
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,225 | 🐛 125 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,636 | 🐛 105 | 🌐 Python | 📅 2026-09-09 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 362 | 🐛 1 | 🌐 C++ | 📅 2026-09-09 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,969 | 🐛 178 | 🌐 C++ | 📅 2026-09-09 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 435 | 🐛 80 | 🌐 C++ | 📅 2026-09-09 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 230 | 🐛 60 | 🌐 C++ | 📅 2026-09-09 - For Delta Lake support.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 490 | 🐛 32 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [UC Catalog Extension](https://github.com/duckdb/uc_catalog) ⭐ 109 | 🐛 38 | 🌐 C++ | 📅 2026-09-09 - Proof-of-concept extension combining the `delta` extension with Unity Catalog.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 2 | 🌐 C++ | 📅 2026-08-10 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 1 | 🌐 Python | 📅 2026-09-09 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
