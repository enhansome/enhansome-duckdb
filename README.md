...
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 286 | 🐛 54 | 🌐 Go | 📅 2026-08-12
* [Ruby](https://github.com/suketa/ruby-duckdb) ⭐ 257 | 🐛 11 | 🌐 Ruby | 📅 2026-08-22
...
* [Haskell](https://github.com/Tritlo/duckdb-haskell) ⭐ 22 | 🐛 4 | 🌐 Haskell | 📅 2026-08-20
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,556 | 🐛 1 | 🌐 Python | 📅 2026-08-22 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,251 | 🐛 279 | 🌐 Python | 📅 2026-08-21 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,069 | 🐛 642 | 🌐 Rust | 📅 2026-08-22 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,827 | 🐛 199 | 🌐 Go | 📅 2026-08-21 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,235 | 🐛 26 | 🌐 Go | 📅 2026-08-21 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,218 | 🐛 73 | 🌐 Rust | 📅 2026-08-22 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 667 | 🐛 48 | 🌐 Go | 📅 2026-08-22 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 608 | 🐛 111 | 🌐 JavaScript | 📅 2026-08-22 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
...
* [yato](https://github.com/Bl3f/yato) ⭐ 349 | 🐛 3 | 🌐 Python | 📅 2025-11-22 - The smallest DuckDB SQL orchestrator on Earth.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 24 | 🌐 HTML | 📅 2026-08-21 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,354 | 🐛 226 | 🌐 Python | 📅 2026-08-21 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,701 | 🐛 245 | 🌐 Python | 📅 2026-08-22 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 530 | 🐛 21 | 🌐 Python | 📅 2026-08-20 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,287 | 🐛 17 | 🌐 Rust | 📅 2026-08-21 - A database TUI with experimental support for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,031 | 🐛 95 | 🌐 Go | 📅 2026-08-22 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 475 | 🐛 51 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,632 | 🐛 2 | 🌐 Makefile | 📅 2026-08-21 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,856 | 🐛 15 | 🌐 Go | 📅 2026-08-21 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,672 | 🐛 36 | 🌐 Go | 📅 2026-08-22 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
...
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - A semantic layer with DuckDB integration.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,620 | 🐛 110 | 🌐 Python | 📅 2026-08-21 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 582 | 🐛 36 | 🌐 Go | 📅 2026-08-22 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,926 | 🐛 169 | 🌐 C++ | 📅 2026-08-20 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 428 | 🐛 87 | 🌐 C++ | 📅 2026-08-21 - For reading Iceberg tables.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 480 | 🐛 31 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-08-22 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
