...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 954 | 🐛 21 | 🌐 Rust | 📅 2026-08-19
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 695 | 🐛 25 | 🌐 C# | 📅 2026-08-15
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 285 | 🐛 54 | 🌐 Go | 📅 2026-08-12
* [Ruby](https://github.com/suketa/ruby-duckdb) ⭐ 256 | 🐛 10 | 🌐 Ruby | 📅 2026-08-15
...
* [Haskell](https://github.com/Tritlo/duckdb-haskell) ⭐ 22 | 🐛 3 | 🌐 Haskell | 📅 2026-08-18
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,545 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,244 | 🐛 266 | 🌐 Python | 📅 2026-08-18 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,069 | 🐛 627 | 🌐 Rust | 📅 2026-08-19 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
...
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,230 | 🐛 21 | 🌐 Go | 📅 2026-08-19 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
...
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 661 | 🐛 39 | 🌐 Go | 📅 2026-08-18 - Time-series data warehouse built on DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 20 | 🌐 HTML | 📅 2026-08-18 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 4,994 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,345 | 🐛 224 | 🌐 Python | 📅 2026-08-13 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [DuckDB.EFCoreProvider](https://github.com/skuirrels/DuckDB.EFCoreProvider) ⭐ 14 | 🐛 1 | 🌐 C# | 📅 2026-08-18 - Entity Framework Core provider for DuckDB and DuckLake, with LINQ, writes, migrations, bulk ingestion, and Parquet-backed tiered storage for .NET.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,281 | 🐛 19 | 🌐 Rust | 📅 2026-08-17 - A database TUI with experimental support for DuckDB.
...
* [tuitab](https://github.com/denisotree/tuitab) ⭐ 27 | 🐛 0 | 🌐 Rust | 📅 2026-08-18 - A Rust TUI for fast, in-depth analytics on large datasets (CSV, JSON, Parquet, Excel, SQLite) powered by DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,022 | 🐛 104 | 🌐 Go | 📅 2026-08-18 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 473 | 🐛 51 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [Ducklings](https://github.com/tobilg/ducklings) ⭐ 247 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-10 - A minimal DuckDB WASM build for browsers and serverless environments like Cloudflare Workers.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,606 | 🐛 2 | 🌐 Makefile | 📅 2026-08-13 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,760 | 🐛 110 | 🌐 Java | 📅 2026-08-16 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,335 | 🐛 83 | 🌐 Python | 📅 2026-08-17 - DuckDB dbt adapter.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,617 | 🐛 107 | 🌐 Python | 📅 2026-08-19 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 582 | 🐛 41 | 🌐 Go | 📅 2025-01-17 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,921 | 🐛 164 | 🌐 C++ | 📅 2026-08-18 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 427 | 🐛 82 | 🌐 C++ | 📅 2026-08-18 - For reading Iceberg tables.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 478 | 🐛 30 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`stats_duck`](https://github.com/KoliStat/the-stats-duck) ⭐ 57 | 🐛 19 | 🌐 C++ | 📅 2026-08-14 - Statistics for tabular and clinical data: descriptive tables (`table_one`), linear models with robust/clustered standard errors, meta-analysis, bootstrap, and a grammar-of-graphics `VISUALIZE` clause that turns queries into Vega-Lite charts.
...
* [duckdb\_engine](https://github.com/Mause/duckdb_engine) ⭐ 495 | 🐛 97 | 🌐 Python | 📅 2026-08-17 - SQLAlchemy driver for DuckDB.
