...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 962 | 🐛 31 | 🌐 Rust | 📅 2026-09-14
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 700 | 🐛 25 | 🌐 C# | 📅 2026-08-28
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 297 | 🐛 49 | 🌐 Go | 📅 2026-09-11
...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 12 | 🐛 0 | 🌐 PHP | 📅 2026-09-12
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,619 | 🐛 3 | 🌐 Python | 📅 2026-09-15 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,290 | 🐛 305 | 🌐 Python | 📅 2026-09-15 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,082 | 🐛 796 | 🌐 Rust | 📅 2026-09-15 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,885 | 🐛 211 | 🌐 Go | 📅 2026-09-15 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
* [Amphi ETL](https://github.com/amphi-ai/amphi-etl) ⭐ 1,402 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-24 - Low-code data pipelines for structured and unstructured data. SQL transformations are powered by DuckDB.
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,303 | 🐛 56 | 🌐 Rust | 📅 2026-09-15 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,249 | 🐛 21 | 🌐 Go | 📅 2026-09-14 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 677 | 🐛 59 | 🌐 Go | 📅 2026-09-15 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 615 | 🐛 116 | 🌐 JavaScript | 📅 2026-09-08 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
* [Tailpipe](https://github.com/turbot/tailpipe) ⭐ 579 | 🐛 40 | 🌐 Go | 📅 2026-09-10 - An open-source SIEM for instant log insights.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 88 | 🐛 22 | 🌐 Go | 📅 2026-09-15 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [ReportBurster](https://github.com/flowkraft/reportburster) ⭐ 76 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-12 - Business Intelligence Done Right - ReportBurster uses DuckDB as its in-process analytics database engine, and for larger workloads, supports ClickHouse too.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 19 | 🌐 HTML | 📅 2026-09-15 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
* [DataCharter](https://github.com/datacharter/datacharter) ⭐ 12 | 🐛 10 | 🌐 Python | 📅 2026-09-15 - Local, contract-governed data explorer. Federates files and databases (Postgres, Snowflake, BigQuery, Excel, and more) through DuckDB — SQL editor, charts, profiling — then hands AI agents a PII-masked, read-only query surface over MCP. Apache-2.0.
...
* [Pondview](https://github.com/paulmupeters/pondview-bi) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12 - Open-source, DuckDB-powered BI workspace for AI-assisted analysis, SQL, charts, and dashboards.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 5,011 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,407 | 🐛 213 | 🌐 Python | 📅 2026-09-15 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,720 | 🐛 260 | 🌐 Python | 📅 2026-09-15 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 532 | 🐛 23 | 🌐 Python | 📅 2026-09-15 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
* [duckdb\_fdw](https://github.com/alitrack/duckdb_fdw) ⭐ 409 | 🐛 23 | 🌐 C | 📅 2026-05-29 - DuckDB Foreign Data Wrapper for PostgreSQL.
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 23 | 🌐 Python | 📅 2026-09-15 - A Python library for downloading and transforming raw OpenStreetMap data into GeoParquet files.
...
* [Vane](https://github.com/AstroVela/vane) ⭐ 131 | 🐛 166 | 🌐 Python | 📅 2026-09-15 - A multimodal-native engine for AI workloads, built on a DuckDB fork with Python and SQL interfaces.
* [flapi](https://github.com/DataZooDE/flapi) ⭐ 73 | 🐛 2 | 🌐 C++ | 📅 2026-09-15 - An API Framework that heavily relies on the power of DuckDB and DuckDB extensions. Ready to build performant and cost-efficient APIs on top of BigQuery or Snowflake for AI Agents and Data Apps.
* [jsqltranspiler](https://github.com/starlake-ai/jsqltranspiler) ⭐ 73 | 🐛 16 | 🌐 Java | 📅 2026-09-14 - Rewrite BigQuery, Redshift, Snowflake and Databricks queries into DuckDB-compatible SQL.
* [Snowflake Emulator](https://github.com/nnnkkk7/snowflake-emulator) ⭐ 48 | 🐛 10 | 🌐 Go | 📅 2026-08-17 - A lightweight Snowflake emulator built with Go and DuckDB for local development and testing.
...
* [Preswald](https://github.com/StructuredLabs/preswald) ⭐ 4,272 | 🐛 330 | 🌐 Python | 📅 2026-06-11 - WASM packager for Python-based interactive data apps.
* [Medama](https://github.com/medama-io/medama) ⭐ 644 | 🐛 34 | 🌐 Go | 📅 2026-08-07 - Self-hostable, privacy-focused website analytics.
* [Duck-UI](https://github.com/caioricciuti/duck-ui) ⭐ 618 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - Duck-UI is a web-based interface for interacting with DuckDB with a SQL editor, data import/export, data explorer, query history, theme toggle and keyboard shortcuts.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,331 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 754 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-15 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
* [Duckling](https://github.com/l1xnan/duckling) ⭐ 580 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-03 - A fast viewer for CSV/Parquet files and DuckDB/SQLite, based on Tauri.
* [rsql](https://github.com/theseus-rs/rsql) ⭐ 450 | 🐛 10 | 🌐 Rust | 📅 2026-09-05 - CLI for DuckDB, LibSQL, MariaDB, MySQL, PostgreSQL, SQLite3 and SQL Server.
...
* [tuitab](https://github.com/denisotree/tuitab) ⭐ 27 | 🐛 6 | 🌐 Rust | 📅 2026-09-14 - A Rust TUI for fast, in-depth analytics on large datasets (CSV, JSON, Parquet, Excel, SQLite) powered by DuckDB.
* [AmoxSQL](https://github.com/DSandovalFlavio/AmoxSQL) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 - The Modern Codex for Local Data Analysis. A high-performance, local-first IDE built specifically for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,063 | 🐛 42 | 🌐 Go | 📅 2026-09-15 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 502 | 🐛 50 | 🌐 Python | 📅 2026-09-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [Ducklings](https://github.com/tobilg/ducklings) ⭐ 260 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-19 - A minimal DuckDB WASM build for browsers and serverless environments like Cloudflare Workers.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,738 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,964 | 🐛 21 | 🌐 Go | 📅 2026-09-15 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,762 | 🐛 112 | 🌐 Java | 📅 2026-09-15 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,708 | 🐛 58 | 🌐 Go | 📅 2026-09-14 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,354 | 🐛 85 | 🌐 Python | 📅 2026-09-14 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 797 | 🐛 47 | 🌐 Go | 📅 2026-09-15 - Enables SQL-based stream processing, powered by DuckDB.
* [metabase\_duckdb\_driver](https://github.com/MotherDuck-Open-Source/metabase_duckdb_driver) ⭐ 170 | 🐛 18 | 🌐 Clojure | 📅 2026-09-15 - Metabase DuckDB Driver shipped as 3rd party plugin.
* [xlDuckDb](https://github.com/RusselWebber/xlDuckDb) ⭐ 163 | 🐛 2 | 🌐 C# | 📅 2026-09-11 - Excel addin to run DuckDB queries in Excel.
* [kwack](https://github.com/rayokota/kwack) ⭐ 155 | 🐛 12 | 🌐 Java | 📅 2026-02-16 - In-Memory Analytics for Kafka using DuckDB.
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 120 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - A semantic layer with DuckDB integration.
...
* [DuckDBExcelAddin](https://github.com/sonhn85/DuckDBExcelAddin) ⭐ 3 | 🐛 3 | 🌐 C | 📅 2026-09-15 - Native Excel XLL add-in for DuckDB with parameter binding, async execution and Excel range table functions.
...
* [AliSQL](https://github.com/alibaba/AliSQL) ⭐ 5,980 | 🐛 15 | 🌐 C++ | 📅 2026-07-18 - A MySQL branch originated from Alibaba Group. Integrates DuckDB as a native storage engine.
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,236 | 🐛 125 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,638 | 🐛 112 | 🌐 Python | 📅 2026-09-15 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 588 | 🐛 40 | 🌐 Go | 📅 2026-09-13 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 366 | 🐛 1 | 🌐 C++ | 📅 2026-09-15 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,986 | 🐛 173 | 🌐 C++ | 📅 2026-09-15 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 435 | 🐛 85 | 🌐 C++ | 📅 2026-09-15 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 231 | 🐛 65 | 🌐 C++ | 📅 2026-09-15 - For Delta Lake support.
* [`azure`](https://github.com/duckdb/duckdb_azure) ⭐ 78 | 🐛 39 | 🌐 C++ | 📅 2026-09-14 - For using the Azure Blob storage.
* [`aws`](https://github.com/duckdb/duckdb_aws) ⭐ 65 | 🐛 38 | 🌐 C++ | 📅 2026-09-15 - For handling AWS credentials.
* [`arrow`](https://github.com/duckdb/arrow) ⭐ 48 | 🐛 3 | 🌐 C++ | 📅 2025-05-12 - A zero-copy data integration between Apache Arrow and DuckDB.
* [`avro`](https://github.com/duckdb/duckdb-avro) ⭐ 35 | 🐛 9 | 🌐 C++ | 📅 2026-09-03 - For reading Avro files.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 493 | 🐛 32 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
* [`gsheets`](https://github.com/evidence-dev/duckdb_gsheets) ⭐ 354 | 🐛 11 | 🌐 C++ | 📅 2026-02-21 - Read and write Google Sheets using SQL.
* [`prql`](https://github.com/ywelsch/duckdb-prql) ⭐ 331 | 🐛 4 | 🌐 C++ | 📅 2026-05-28 - Run PRQL commands directly within DuckDB.
...
* [`bigquery`](https://github.com/hafenkran/duckdb-bigquery) ⭐ 170 | 🐛 8 | 🌐 C++ | 📅 2026-08-09 - Integrates DuckDB with Google BigQuery, allowing direct querying and management of BigQuery datasets.
...
* [`cache_httpfs`](https://github.com/dentiny/duck-read-cache-fs) ⭐ 151 | 🐛 16 | 🌐 C++ | 📅 2026-08-06 - Adds a read caching layer to duckdb filesystem to improve query performance and reduce egress cost.
* [`onager`](https://github.com/CogitatorTech/onager) ⭐ 149 | 🐛 3 | 🌐 Rust | 📅 2026-07-30 - A DuckDB extension for graph data analytics.
* [`infera`](https://github.com/CogitatorTech/infera) ⭐ 137 | 🐛 5 | 🌐 Rust | 📅 2026-07-22 - A DuckDB extension for in-database inference.
* [`dash`](https://github.com/gropaul/dash) ⭐ 104 | 🐛 0 | 🌐 C++ | 📅 2026-09-04 - Fully local data canvas and dashboarding app within DuckDB.
...
* [`duckherder`](https://github.com/dentiny/duckdb-distributed-execution) ⭐ 61 | 🐛 17 | 🌐 C++ | 📅 2026-09-14 - Distributed execution for DuckDB queries.
...
* [`gpudb`](https://github.com/singhpratech/duckdbgpumetaldbram) ⭐ 20 | 🐛 6 | 🌐 C++ | 📅 2026-09-14 - GPU-accelerated aggregates, GROUP BY and hash joins on NVIDIA CUDA and Apple Silicon Metal, with GPU-resident columns for repeated queries.
* [`gaggle`](https://github.com/CogitatorTech/gaggle) ⭐ 19 | 🐛 2 | 🌐 Rust | 📅 2026-07-22 - A DuckDB extension for working with Kaggle datasets.
* [`query_condition_cache`](https://github.com/dentiny/duckdb-query-condition-cache) ⭐ 19 | 🐛 23 | 🌐 C++ | 📅 2026-09-13 - Caches query conditions to improve performance for repeated-query workloads.
...
* [duckdb\_engine](https://github.com/Mause/duckdb_engine) ⭐ 497 | 🐛 99 | 🌐 Python | 📅 2026-09-14 - SQLAlchemy driver for DuckDB.
* [FlockMTL](https://github.com/dsg-polymtl/flockmtl) ⭐ 358 | 🐛 26 | 🌐 C++ | 📅 2026-07-26 - Integrate language model (LLM) capabilities directly into your queries and workflows.
* [UC Catalog Extension](https://github.com/duckdb/uc_catalog) ⭐ 110 | 🐛 39 | 🌐 C++ | 📅 2026-09-14 - Proof-of-concept extension combining the `delta` extension with Unity Catalog.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 3 | 🌐 C++ | 📅 2026-09-15 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
