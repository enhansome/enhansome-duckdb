...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 950 | 🐛 21 | 🌐 Rust | 📅 2026-08-10
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 695 | 🐛 24 | 🌐 C# | 📅 2026-07-26
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 283 | 🐛 50 | 🌐 Go | 📅 2026-08-12
* [Ruby](https://github.com/suketa/ruby-duckdb) ⭐ 255 | 🐛 10 | 🌐 Ruby | 📅 2026-08-11
* [PHP](https://github.com/satur-io/duckdb-php) ⭐ 86 | 🐛 15 | 🌐 C | 📅 2026-04-02
...
* [Common Lisp](https://github.com/ak-coram/cl-duckdb) ⭐ 54 | 🐛 4 | 🌐 Common Lisp | 📅 2026-07-29
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,524 | 🐛 5 | 🌐 Python | 📅 2026-08-12 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,243 | 🐛 264 | 🌐 Python | 📅 2026-08-12 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,064 | 🐛 584 | 🌐 Rust | 📅 2026-08-13 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,804 | 🐛 195 | 🌐 Go | 📅 2026-08-12 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
* [Amphi ETL](https://github.com/amphi-ai/amphi-etl) ⭐ 1,385 | 🐛 128 | 🌐 TypeScript | 📅 2026-07-23 - Low-code data pipelines for structured and unstructured data. SQL transformations are powered by DuckDB.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,022 | 🐛 57 | 🌐 Rust | 📅 2026-08-12 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 637 | 🐛 40 | 🌐 Go | 📅 2026-08-09 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 605 | 🐛 112 | 🌐 JavaScript | 📅 2026-08-08 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
* [Tailpipe](https://github.com/turbot/tailpipe) ⭐ 577 | 🐛 39 | 🌐 Go | 📅 2026-08-09 - An open-source SIEM for instant log insights.
* [Sloggo](https://github.com/phare/sloggo) ⭐ 458 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-13 - Minimal RFC 5424 syslog collector and viewer based on DuckDB. Runs as a single, resource-friendly process.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 21 | 🌐 HTML | 📅 2026-08-11 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [AnkaFlow](https://github.com/targetta/ankaflow) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-08-12 - YAML-based data pipeline framework that runs both locally and fully in-browser designed for data engineers, ML teams, and SaaS developers who need flexible, SQL-powered pipelines.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 4,979 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,336 | 🐛 221 | 🌐 Python | 📅 2026-08-12 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,695 | 🐛 253 | 🌐 Python | 📅 2026-08-13 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 528 | 🐛 21 | 🌐 Python | 📅 2026-08-12 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 355 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-12 - Easy-to-use and high-performance JavaScript library for data analysis.
...
* [Snowflake Emulator](https://github.com/nnnkkk7/snowflake-emulator) ⭐ 44 | 🐛 10 | 🌐 Go | 📅 2026-08-01 - A lightweight Snowflake emulator built with Go and DuckDB for local development and testing.
...
* [DuckDB.EFCoreProvider](https://github.com/skuirrels/DuckDB.EFCoreProvider) ⭐ 12 | 🐛 1 | 🌐 C# | 📅 2026-08-12 - Entity Framework Core provider for DuckDB and DuckLake, with LINQ, writes, migrations, bulk ingestion, and Parquet-backed tiered storage for .NET.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,269 | 🐛 17 | 🌐 Rust | 📅 2026-08-08 - A database TUI with experimental support for DuckDB.
...
* [tuitab](https://github.com/denisotree/tuitab) ⭐ 26 | 🐛 0 | 🌐 Rust | 📅 2026-08-12 - A Rust TUI for fast, in-depth analytics on large datasets (CSV, JSON, Parquet, Excel, SQLite) powered by DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,004 | 🐛 82 | 🌐 Go | 📅 2026-08-13 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 470 | 🐛 50 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [Ducklings](https://github.com/tobilg/ducklings) ⭐ 245 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-10 - A minimal DuckDB WASM build for browsers and serverless environments like Cloudflare Workers.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,541 | 🐛 4 | 🌐 Makefile | 📅 2026-08-12 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,760 | 🐛 110 | 🌐 Java | 📅 2026-08-10 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,332 | 🐛 82 | 🌐 Python | 📅 2026-08-12 - DuckDB dbt adapter.
...
* [metabase\_duckdb\_driver](https://github.com/MotherDuck-Open-Source/metabase_duckdb_driver) ⭐ 167 | 🐛 20 | 🌐 Clojure | 📅 2026-08-12 - Metabase DuckDB Driver shipped as 3rd party plugin.
* [kwack](https://github.com/rayokota/kwack) ⭐ 155 | 🐛 12 | 🌐 Java | 📅 2026-02-16 - In-Memory Analytics for Kafka using DuckDB.
* [xlDuckDb](https://github.com/RusselWebber/xlDuckDb) ⭐ 147 | 🐛 1 | 🌐 C# | 📅 2026-07-24 - Excel addin to run DuckDB queries in Excel.
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 113 | 🐛 0 | 🌐 Python | 📅 2026-08-06 - A semantic layer with DuckDB integration.
* [duckdb-power-query-connector](https://github.com/MotherDuck-Open-Source/duckdb-power-query-connector) ⭐ 88 | 🐛 7 | 🌐 Power Query | 📅 2026-07-29 - DuckDB Power Query Custom Connector.
...
* [DuckDB VBA](https://github.com/EtienneLenoir/duckdb-vba) ⭐ 8 | 🐛 0 | 🌐 VBA | 📅 2026-06-11 - Excel/VBA integration for DuckDB using the native C API through a lightweight DLL bridge. Supports Range/Array ingestion, dictionary lookups, Parquet/CSV/JSON workflows, SQLite/PostgreSQL connectivity, and Access-to-DuckDB migration.
...
* [AliSQL](https://github.com/alibaba/AliSQL) ⭐ 5,868 | 🐛 18 | 🌐 C++ | 📅 2026-07-18 - A MySQL branch originated from Alibaba Group. Integrates DuckDB as a native storage engine.
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,188 | 🐛 112 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,609 | 🐛 107 | 🌐 Python | 📅 2026-08-12 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 355 | 🐛 5 | 🌐 C++ | 📅 2026-07-31 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,913 | 🐛 158 | 🌐 C++ | 📅 2026-08-12 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 425 | 🐛 75 | 🌐 C++ | 📅 2026-08-12 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 228 | 🐛 62 | 🌐 C++ | 📅 2026-08-12 - For Delta Lake support.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 471 | 🐛 30 | 🌐 C++ | 📅 2026-08-12 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`dash`](https://github.com/gropaul/dash) ⭐ 90 | 🐛 2 | 🌐 C++ | 📅 2026-07-31 - Fully local data canvas and dashboarding app within DuckDB.
...
* [`stats_duck`](https://github.com/KoliStat/the-stats-duck) ⭐ 55 | 🐛 16 | 🌐 C++ | 📅 2026-08-06 - Statistics for tabular and clinical data: descriptive tables (`table_one`), linear models with robust/clustered standard errors, meta-analysis, bootstrap, and a grammar-of-graphics `VISUALIZE` clause that turns queries into Vega-Lite charts.
...
* [duckdb\_engine](https://github.com/Mause/duckdb_engine) ⭐ 495 | 🐛 97 | 🌐 Python | 📅 2026-08-12 - SQLAlchemy driver for DuckDB.
...
* [UC Catalog Extension](https://github.com/duckdb/uc_catalog) ⭐ 108 | 🐛 32 | 🌐 C++ | 📅 2026-08-12 - Proof-of-concept extension combining the `delta` extension with Unity Catalog.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 114 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
