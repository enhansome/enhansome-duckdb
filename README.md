...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 9 | 🐛 0 | 🌐 PHP | 📅 2026-08-27
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,576 | 🐛 3 | 🌐 Python | 📅 2026-08-27 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,258 | 🐛 275 | 🌐 Python | 📅 2026-08-28 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,071 | 🐛 753 | 🌐 Rust | 📅 2026-08-28 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,848 | 🐛 207 | 🌐 Go | 📅 2026-08-28 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,243 | 🐛 26 | 🌐 Go | 📅 2026-08-26 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,243 | 🐛 62 | 🌐 Rust | 📅 2026-08-27 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 669 | 🐛 48 | 🌐 Go | 📅 2026-08-28 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 610 | 🐛 116 | 🌐 JavaScript | 📅 2026-08-23 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
...
* [Pondview](https://github.com/paulmupeters/pondview-bi) ⭐ 1 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-27 - Open-source, DuckDB-powered BI workspace for AI-assisted analysis, SQL, charts, and dashboards.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 5,001 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,368 | 🐛 215 | 🌐 Python | 📅 2026-08-26 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,709 | 🐛 245 | 🌐 Python | 📅 2026-08-27 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-27 - Easy-to-use and high-performance JavaScript library for data analysis.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,299 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,040 | 🐛 95 | 🌐 Go | 📅 2026-08-27 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 484 | 🐛 52 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,653 | 🐛 2 | 🌐 Makefile | 📅 2026-08-21 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,885 | 🐛 16 | 🌐 Go | 📅 2026-08-27 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,678 | 🐛 31 | 🌐 Go | 📅 2026-08-27 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
...
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,212 | 🐛 119 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,626 | 🐛 117 | 🌐 Python | 📅 2026-08-28 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,945 | 🐛 177 | 🌐 C++ | 📅 2026-08-27 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 431 | 🐛 91 | 🌐 C++ | 📅 2026-08-26 - For reading Iceberg tables.
...
* [`dash`](https://github.com/gropaul/dash) ⭐ 98 | 🐛 2 | 🌐 C++ | 📅 2026-08-13 - Fully local data canvas and dashboarding app within DuckDB.
...
* [`pst`](https://github.com/intellekthq/duckdb-pst) ⭐ 10 | 🐛 1 | 🌐 C++ | 📅 2026-08-03 - Read Microsoft PST files in-place with rich schemas for emails, contacts, appointments, tasks, and more.
