...
* [Awesome DuckLake](https://github.com/esadek/awesome-ducklake) ⭐ 142 | 🐛 5 | 📅 2026-04-20 - A curated list of awesome DuckLake tools and resources.
...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 952 | 🐛 21 | 🌐 Rust | 📅 2026-08-17
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 695 | 🐛 24 | 🌐 C# | 📅 2026-08-15
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 284 | 🐛 53 | 🌐 Go | 📅 2026-08-12
* [Ruby](https://github.com/suketa/ruby-duckdb) ⭐ 255 | 🐛 10 | 🌐 Ruby | 📅 2026-08-15
* [PHP](https://github.com/satur-io/duckdb-php) ⭐ 87 | 🐛 10 | 🌐 C | 📅 2026-08-15
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,536 | 🐛 2 | 🌐 Python | 📅 2026-08-17 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,245 | 🐛 267 | 🌐 Python | 📅 2026-08-17 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,067 | 🐛 644 | 🌐 Rust | 📅 2026-08-17 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,813 | 🐛 201 | 🌐 Go | 📅 2026-08-17 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
* [Amphi ETL](https://github.com/amphi-ai/amphi-etl) ⭐ 1,396 | 🐛 128 | 🌐 TypeScript | 📅 2026-07-23 - Low-code data pipelines for structured and unstructured data. SQL transformations are powered by DuckDB.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,210 | 🐛 25 | 🌐 Go | 📅 2026-08-17 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,144 | 🐛 57 | 🌐 Rust | 📅 2026-08-17 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 647 | 🐛 39 | 🌐 Go | 📅 2026-08-14 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 608 | 🐛 111 | 🌐 JavaScript | 📅 2026-08-14 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 82 | 🐛 6 | 🌐 Go | 📅 2026-08-17 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 22 | 🌐 HTML | 📅 2026-08-16 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 4,989 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,342 | 🐛 224 | 🌐 Python | 📅 2026-08-13 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,698 | 🐛 257 | 🌐 Python | 📅 2026-08-13 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [DuckDB.EFCoreProvider](https://github.com/skuirrels/DuckDB.EFCoreProvider) ⭐ 14 | 🐛 1 | 🌐 C# | 📅 2026-08-15 - Entity Framework Core provider for DuckDB and DuckLake, with LINQ, writes, migrations, bulk ingestion, and Parquet-backed tiered storage for .NET.
...
* [Preswald](https://github.com/StructuredLabs/preswald) ⭐ 4,281 | 🐛 330 | 🌐 Python | 📅 2026-06-11 - WASM packager for Python-based interactive data apps.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,276 | 🐛 17 | 🌐 Rust | 📅 2026-08-17 - A database TUI with experimental support for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,012 | 🐛 93 | 🌐 Go | 📅 2026-08-17 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 472 | 🐛 51 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,597 | 🐛 2 | 🌐 Makefile | 📅 2026-08-13 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
...
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,334 | 🐛 83 | 🌐 Python | 📅 2026-08-17 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 784 | 🐛 33 | 🌐 Python | 📅 2025-09-04 - Enables SQL-based stream processing, powered by DuckDB.
* [metabase\_duckdb\_driver](https://github.com/MotherDuck-Open-Source/metabase_duckdb_driver) ⭐ 167 | 🐛 18 | 🌐 Clojure | 📅 2026-08-17 - Metabase DuckDB Driver shipped as 3rd party plugin.
...
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,193 | 🐛 113 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,615 | 🐛 105 | 🌐 Python | 📅 2026-08-17 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 357 | 🐛 5 | 🌐 C++ | 📅 2026-08-17 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,918 | 🐛 164 | 🌐 C++ | 📅 2026-08-13 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 426 | 🐛 79 | 🌐 C++ | 📅 2026-08-17 - For reading Iceberg tables.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 474 | 🐛 30 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`dash`](https://github.com/gropaul/dash) ⭐ 93 | 🐛 1 | 🌐 C++ | 📅 2026-08-13 - Fully local data canvas and dashboarding app within DuckDB.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
