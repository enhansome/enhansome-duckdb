...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 960 | 🐛 29 | 🌐 Rust | 📅 2026-09-10
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 698 | 🐛 25 | 🌐 C# | 📅 2026-08-28
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 296 | 🐛 52 | 🌐 Go | 📅 2026-09-08
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,603 | 🐛 5 | 🌐 Python | 📅 2026-09-10 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,282 | 🐛 297 | 🌐 Python | 📅 2026-09-10 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,080 | 🐛 794 | 🌐 Rust | 📅 2026-09-10 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,874 | 🐛 215 | 🌐 Go | 📅 2026-09-10 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,287 | 🐛 59 | 🌐 Rust | 📅 2026-09-09 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,248 | 🐛 21 | 🌐 Go | 📅 2026-09-10 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 676 | 🐛 45 | 🌐 Go | 📅 2026-09-10 - Time-series data warehouse built on DuckDB.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 87 | 🐛 9 | 🌐 Go | 📅 2026-09-04 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [ReportBurster](https://github.com/flowkraft/reportburster) ⭐ 76 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-10 - Business Intelligence Done Right - ReportBurster uses DuckDB as its in-process analytics database engine, and for larger workloads, supports ClickHouse too.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 17 | 🌐 HTML | 📅 2026-09-10 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,395 | 🐛 207 | 🌐 Python | 📅 2026-09-10 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,718 | 🐛 256 | 🌐 Python | 📅 2026-09-10 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [jsqltranspiler](https://github.com/starlake-ai/jsqltranspiler) ⭐ 73 | 🐛 15 | 🌐 Java | 📅 2026-09-06 - Rewrite BigQuery, Redshift, Snowflake and Databricks queries into DuckDB-compatible SQL.
...
* [Duck-UI](https://github.com/caioricciuti/duck-ui) ⭐ 616 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - Duck-UI is a web-based interface for interacting with DuckDB with a SQL editor, data import/export, data explorer, query history, theme toggle and keyboard shortcuts.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,324 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
* [Duckling](https://github.com/l1xnan/duckling) ⭐ 579 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-03 - A fast viewer for CSV/Parquet files and DuckDB/SQLite, based on Tauri.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 567 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-10 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [AmoxSQL](https://github.com/DSandovalFlavio/AmoxSQL) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - The Modern Codex for Local Data Analysis. A high-performance, local-first IDE built specifically for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,059 | 🐛 39 | 🌐 Go | 📅 2026-09-10 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,721 | 🐛 6 | 🌐 Makefile | 📅 2026-09-10 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,954 | 🐛 18 | 🌐 Go | 📅 2026-09-10 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,763 | 🐛 111 | 🌐 Java | 📅 2026-09-10 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,702 | 🐛 59 | 🌐 Go | 📅 2026-09-10 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,350 | 🐛 86 | 🌐 Python | 📅 2026-09-08 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 795 | 🐛 56 | 🌐 Go | 📅 2026-09-10 - Enables SQL-based stream processing, powered by DuckDB.
...
* [xlDuckDb](https://github.com/RusselWebber/xlDuckDb) ⭐ 158 | 🐛 1 | 🌐 C# | 📅 2026-09-05 - Excel addin to run DuckDB queries in Excel.
...
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,234 | 🐛 125 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,636 | 🐛 106 | 🌐 Python | 📅 2026-09-10 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 363 | 🐛 1 | 🌐 C++ | 📅 2026-09-10 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,972 | 🐛 179 | 🌐 C++ | 📅 2026-09-10 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 435 | 🐛 82 | 🌐 C++ | 📅 2026-09-09 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 231 | 🐛 62 | 🌐 C++ | 📅 2026-09-10 - For Delta Lake support.
* [`azure`](https://github.com/duckdb/duckdb_azure) ⭐ 78 | 🐛 39 | 🌐 C++ | 📅 2026-08-12 - For using the Azure Blob storage.
* [`aws`](https://github.com/duckdb/duckdb_aws) ⭐ 65 | 🐛 36 | 🌐 C++ | 📅 2026-09-10 - For handling AWS credentials.
...
* [UC Catalog Extension](https://github.com/duckdb/uc_catalog) ⭐ 110 | 🐛 38 | 🌐 C++ | 📅 2026-09-10 - Proof-of-concept extension combining the `delta` extension with Unity Catalog.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 10 | 🌐 C++ | 📅 2026-09-10 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 2 | 🌐 Python | 📅 2026-09-10 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
