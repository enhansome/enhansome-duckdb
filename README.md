...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,526 | 🐛 4 | 🌐 Python | 📅 2026-08-13 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,243 | 🐛 265 | 🌐 Python | 📅 2026-08-12 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,064 | 🐛 598 | 🌐 Rust | 📅 2026-08-13 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,808 | 🐛 195 | 🌐 Go | 📅 2026-08-12 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
* [Amphi ETL](https://github.com/amphi-ai/amphi-etl) ⭐ 1,388 | 🐛 128 | 🌐 TypeScript | 📅 2026-07-23 - Low-code data pipelines for structured and unstructured data. SQL transformations are powered by DuckDB.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,014 | 🐛 57 | 🌐 Rust | 📅 2026-08-12 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 638 | 🐛 41 | 🌐 Go | 📅 2026-08-13 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 606 | 🐛 112 | 🌐 JavaScript | 📅 2026-08-13 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
* [Tailpipe](https://github.com/turbot/tailpipe) ⭐ 577 | 🐛 39 | 🌐 Go | 📅 2026-08-09 - An open-source SIEM for instant log insights.
* [Sloggo](https://github.com/phare/sloggo) ⭐ 459 | 🐛 2 | 🌐 TypeScript | 📅 2026-05-13 - Minimal RFC 5424 syslog collector and viewer based on DuckDB. Runs as a single, resource-friendly process.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 4,982 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,337 | 🐛 223 | 🌐 Python | 📅 2026-08-13 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,696 | 🐛 252 | 🌐 Python | 📅 2026-08-13 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 528 | 🐛 21 | 🌐 Python | 📅 2026-08-13 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 355 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-13 - Easy-to-use and high-performance JavaScript library for data analysis.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,270 | 🐛 17 | 🌐 Rust | 📅 2026-08-08 - A database TUI with experimental support for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,004 | 🐛 83 | 🌐 Go | 📅 2026-08-13 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 471 | 🐛 50 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,561 | 🐛 5 | 🌐 Makefile | 📅 2026-08-12 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
...
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,333 | 🐛 82 | 🌐 Python | 📅 2026-08-12 - DuckDB dbt adapter.
...
* [metabase\_duckdb\_driver](https://github.com/MotherDuck-Open-Source/metabase_duckdb_driver) ⭐ 167 | 🐛 22 | 🌐 Clojure | 📅 2026-08-13 - Metabase DuckDB Driver shipped as 3rd party plugin.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,610 | 🐛 108 | 🌐 Python | 📅 2026-08-13 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 356 | 🐛 5 | 🌐 C++ | 📅 2026-07-31 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,913 | 🐛 159 | 🌐 C++ | 📅 2026-08-13 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 425 | 🐛 81 | 🌐 C++ | 📅 2026-08-12 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 228 | 🐛 60 | 🌐 C++ | 📅 2026-08-13 - For Delta Lake support.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 471 | 🐛 30 | 🌐 C++ | 📅 2026-08-13 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`dash`](https://github.com/gropaul/dash) ⭐ 90 | 🐛 1 | 🌐 C++ | 📅 2026-08-13 - Fully local data canvas and dashboarding app within DuckDB.
...
* [duckdb\_engine](https://github.com/Mause/duckdb_engine) ⭐ 495 | 🐛 97 | 🌐 Python | 📅 2026-08-13 - SQLAlchemy driver for DuckDB.
