...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 957 | 🐛 24 | 🌐 Rust | 📅 2026-08-28
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 698 | 🐛 23 | 🌐 C# | 📅 2026-08-28
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 290 | 🐛 51 | 🌐 Go | 📅 2026-08-28
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,579 | 🐛 8 | 🌐 Python | 📅 2026-08-28 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,260 | 🐛 273 | 🌐 Python | 📅 2026-08-29 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,074 | 🐛 783 | 🌐 Rust | 📅 2026-08-29 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,252 | 🐛 43 | 🌐 Rust | 📅 2026-08-29 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,244 | 🐛 30 | 🌐 Go | 📅 2026-08-28 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 85 | 🐛 10 | 🌐 Go | 📅 2026-08-29 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 5,002 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,369 | 🐛 216 | 🌐 Python | 📅 2026-08-28 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,710 | 🐛 246 | 🌐 Python | 📅 2026-08-29 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,043 | 🐛 90 | 🌐 Go | 📅 2026-08-29 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 485 | 🐛 52 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,661 | 🐛 3 | 🌐 Makefile | 📅 2026-08-21 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,919 | 🐛 29 | 🌐 Go | 📅 2026-08-29 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,762 | 🐛 111 | 🌐 Java | 📅 2026-08-19 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,680 | 🐛 58 | 🌐 Go | 📅 2026-08-29 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
...
* [AliSQL](https://github.com/alibaba/AliSQL) ⭐ 5,874 | 🐛 12 | 🌐 C++ | 📅 2026-07-18 - A MySQL branch originated from Alibaba Group. Integrates DuckDB as a native storage engine.
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,215 | 🐛 121 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,949 | 🐛 178 | 🌐 C++ | 📅 2026-08-28 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 432 | 🐛 91 | 🌐 C++ | 📅 2026-08-26 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 228 | 🐛 61 | 🌐 C++ | 📅 2026-08-28 - For Delta Lake support.
...
* [duckdb\_engine](https://github.com/Mause/duckdb_engine) ⭐ 497 | 🐛 97 | 🌐 Python | 📅 2026-08-24 - SQLAlchemy driver for DuckDB.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
