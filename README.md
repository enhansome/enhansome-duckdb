...
* [Awesome DuckLake](https://github.com/esadek/awesome-ducklake) ⭐ 146 | 🐛 5 | 📅 2026-04-20 - A curated list of awesome DuckLake tools and resources.
...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 960 | 🐛 29 | 🌐 Rust | 📅 2026-09-11
...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 10 | 🐛 0 | 🌐 PHP | 📅 2026-09-09
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,604 | 🐛 4 | 🌐 Python | 📅 2026-09-11 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,282 | 🐛 299 | 🌐 Python | 📅 2026-09-10 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,080 | 🐛 794 | 🌐 Rust | 📅 2026-09-11 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,877 | 🐛 210 | 🌐 Go | 📅 2026-09-11 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,293 | 🐛 56 | 🌐 Rust | 📅 2026-09-11 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,248 | 🐛 24 | 🌐 Go | 📅 2026-09-11 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 677 | 🐛 44 | 🌐 Go | 📅 2026-09-11 - Time-series data warehouse built on DuckDB.
...
* [Tailpipe](https://github.com/turbot/tailpipe) ⭐ 580 | 🐛 40 | 🌐 Go | 📅 2026-09-10 - An open-source SIEM for instant log insights.
...
* [HitKeep](https://github.com/PascaleBeier/hitkeep) ⭐ 88 | 🐛 9 | 🌐 Go | 📅 2026-09-04 - Open-source, privacy-first web analytics for traffic, funnels, ecommerce, Search Console, and AI visibility. Runs as a single Go binary with embedded DuckDB.
...
* [ReportBurster](https://github.com/flowkraft/reportburster) ⭐ 76 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-11 - Business Intelligence Done Right - ReportBurster uses DuckDB as its in-process analytics database engine, and for larger workloads, supports ClickHouse too.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 17 | 🌐 HTML | 📅 2026-09-11 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Pondview](https://github.com/paulmupeters/pondview-bi) ⭐ 1 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-03 - Open-source, DuckDB-powered BI workspace for AI-assisted analysis, SQL, charts, and dashboards.
...
* [smallpond](https://github.com/deepseek-ai/smallpond) ⭐ 5,006 | 🐛 34 | 🌐 Python | 📅 2025-03-05 - A distributed data processing framework by DeepSeek built on DuckDB and 3FS.
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,398 | 🐛 211 | 🌐 Python | 📅 2026-09-11 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,719 | 🐛 256 | 🌐 Python | 📅 2026-09-11 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [Vane](https://github.com/AstroVela/vane) ⭐ 129 | 🐛 167 | 🌐 Python | 📅 2026-09-11 - A multimodal-native engine for AI workloads, built on a DuckDB fork with Python and SQL interfaces.
* [flapi](https://github.com/DataZooDE/flapi) ⭐ 73 | 🐛 2 | 🌐 C++ | 📅 2026-09-02 - An API Framework that heavily relies on the power of DuckDB and DuckDB extensions. Ready to build performant and cost-efficient APIs on top of BigQuery or Snowflake for AI Agents and Data Apps.
...
* [DuckDB.EFCoreProvider](https://github.com/skuirrels/DuckDB.EFCoreProvider) ⭐ 14 | 🐛 0 | 🌐 C# | 📅 2026-09-05 - Entity Framework Core provider for DuckDB and DuckLake, with LINQ, writes, migrations, bulk ingestion, and Parquet-backed tiered storage for .NET.
...
* [Preswald](https://github.com/StructuredLabs/preswald) ⭐ 4,274 | 🐛 330 | 🌐 Python | 📅 2026-06-11 - WASM packager for Python-based interactive data apps.
* [Medama](https://github.com/medama-io/medama) ⭐ 642 | 🐛 34 | 🌐 Go | 📅 2026-08-07 - Self-hostable, privacy-focused website analytics.
* [Duck-UI](https://github.com/caioricciuti/duck-ui) ⭐ 617 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - Duck-UI is a web-based interface for interacting with DuckDB with a SQL editor, data import/export, data explorer, query history, theme toggle and keyboard shortcuts.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,325 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A database TUI with experimental support for DuckDB.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 632 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-11 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,060 | 🐛 38 | 🌐 Go | 📅 2026-09-11 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,723 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,956 | 🐛 19 | 🌐 Go | 📅 2026-09-11 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,763 | 🐛 111 | 🌐 Java | 📅 2026-09-11 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,702 | 🐛 57 | 🌐 Go | 📅 2026-09-11 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,350 | 🐛 86 | 🌐 Python | 📅 2026-09-08 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 797 | 🐛 56 | 🌐 Go | 📅 2026-09-11 - Enables SQL-based stream processing, powered by DuckDB.
* [metabase\_duckdb\_driver](https://github.com/MotherDuck-Open-Source/metabase_duckdb_driver) ⭐ 169 | 🐛 18 | 🌐 Clojure | 📅 2026-09-11 - Metabase DuckDB Driver shipped as 3rd party plugin.
...
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 119 | 🐛 5 | 🌐 Python | 📅 2026-09-11 - A semantic layer with DuckDB integration.
...
* [DuckDBExcelAddin](https://github.com/sonhn85/DuckDBExcelAddin) ⭐ 3 | 🐛 1 | 🌐 C | 📅 2026-09-09 - Native Excel XLL add-in for DuckDB with parameter binding, async execution and Excel range table functions.
...
* [AliSQL](https://github.com/alibaba/AliSQL) ⭐ 5,978 | 🐛 15 | 🌐 C++ | 📅 2026-07-18 - A MySQL branch originated from Alibaba Group. Integrates DuckDB as a native storage engine.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,636 | 🐛 109 | 🌐 Python | 📅 2026-09-11 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 588 | 🐛 39 | 🌐 Go | 📅 2026-09-07 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 363 | 🐛 1 | 🌐 C++ | 📅 2026-09-11 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,975 | 🐛 178 | 🌐 C++ | 📅 2026-09-10 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 435 | 🐛 81 | 🌐 C++ | 📅 2026-09-11 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 231 | 🐛 62 | 🌐 C++ | 📅 2026-09-11 - For Delta Lake support.
...
* [`query_condition_cache`](https://github.com/dentiny/duckdb-query-condition-cache) ⭐ 19 | 🐛 22 | 🌐 C++ | 📅 2026-07-25 - Caches query conditions to improve performance for repeated-query workloads.
...
* [UC Catalog Extension](https://github.com/duckdb/uc_catalog) ⭐ 110 | 🐛 38 | 🌐 C++ | 📅 2026-09-11 - Proof-of-concept extension combining the `delta` extension with Unity Catalog.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 5 | 🌐 C++ | 📅 2026-09-11 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 117 | 🐛 2 | 🌐 Python | 📅 2026-09-11 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
