...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 969 | 🐛 30 | 🌐 Rust | 📅 2026-09-23
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 701 | 🐛 26 | 🌐 C# | 📅 2026-09-23
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 298 | 🐛 50 | 🌐 Go | 📅 2026-09-22
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,631 | 🐛 5 | 🌐 Python | 📅 2026-09-23 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,295 | 🐛 306 | 🌐 Python | 📅 2026-09-22 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,090 | 🐛 859 | 🌐 Rust | 📅 2026-09-23 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,913 | 🐛 202 | 🌐 Go | 📅 2026-09-23 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
...
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,322 | 🐛 63 | 🌐 Rust | 📅 2026-09-23 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,251 | 🐛 21 | 🌐 Go | 📅 2026-09-23 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
...
* [ReportBurster](https://github.com/flowkraft/reportburster) ⭐ 77 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-23 - Business Intelligence Done Right - ReportBurster uses DuckDB as its in-process analytics database engine, and for larger workloads, supports ClickHouse too.
...
* [Hydra ETL](https://github.com/bejaouibechir/Hydra) ⭐ 2 | 🐛 6 | 🌐 Python | 📅 2026-09-23 - Declarative YAML ETL engine that can run each transformation step on DuckDB or pandas.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,425 | 🐛 215 | 🌐 Python | 📅 2026-09-22 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,723 | 🐛 259 | 🌐 Python | 📅 2026-09-23 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 532 | 🐛 23 | 🌐 Python | 📅 2026-09-23 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
* [duckdb\_fdw](https://github.com/alitrack/duckdb_fdw) ⭐ 411 | 🐛 23 | 🌐 C | 📅 2026-09-23 - DuckDB Foreign Data Wrapper for PostgreSQL.
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 23 | 🌐 Python | 📅 2026-09-23 - A Python library for downloading and transforming raw OpenStreetMap data into GeoParquet files.
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-23 - Easy-to-use and high-performance JavaScript library for data analysis.
* [Vane](https://github.com/AstroVela/vane) ⭐ 135 | 🐛 185 | 🌐 Python | 📅 2026-09-23 - A multimodal-native engine for AI workloads, built on a DuckDB fork with Python and SQL interfaces.
* [flapi](https://github.com/DataZooDE/flapi) ⭐ 73 | 🐛 4 | 🌐 C++ | 📅 2026-09-23 - An API Framework that heavily relies on the power of DuckDB and DuckDB extensions. Ready to build performant and cost-efficient APIs on top of BigQuery or Snowflake for AI Agents and Data Apps.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,345 | 🐛 14 | 🌐 Rust | 📅 2026-09-23 - A database TUI with experimental support for DuckDB.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 873 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-23 - Browser-based SQL IDE that opens DuckDB database files alongside PostgreSQL, MySQL, ClickHouse and other engines, with a schema explorer and JSON EXPLAIN plans. MIT licensed, runs as a container or Helm chart.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,070 | 🐛 58 | 🌐 Go | 📅 2026-09-23 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [dlt-dbt-duckdb-evidence](https://github.com/Ddscully/dlt-dbt-duckdb-evidence) ⭐ 2 | 🐛 3 | 🌐 Python | 📅 2026-09-23 - End-to-end pipeline over seven public data sources in a single DuckDB file, using dlt, dbt, Polars, Dagster and Evidence. Rebuilds from live sources on every push and publishes the DuckDB file and per-table Parquet monthly.
* [GTFS Scorecard](https://github.com/ChelseaKR/gtfs-scorecard) ⭐ 1 | 🐛 27 | 🌐 HTML | 📅 2026-09-23 - Data-quality grades for 2,400+ public transit (GTFS) feed records. DuckDB builds the cross-agency query layer and a public Parquet table that DuckDB can query over HTTP, and the site's SQL page runs DuckDB-WASM in the browser.
...
* [PH Catalog](https://github.com/sarthakagrawal927/ph-catalog) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Resumable local Product Hunt catalogue and analytics pipeline that normalizes records into DuckDB and exports verified Parquet snapshots.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,762 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,974 | 🐛 19 | 🌐 Go | 📅 2026-09-23 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
* [manifold-sql (DuckDB for Java)](https://github.com/manifold-systems/manifold/blob/master/docs/articles/duckdb_info.md) ⭐ 2,760 | 🐛 111 | 🌐 Java | 📅 2026-09-20 - Use native DuckDB SQL of any complexity directly & type-safely in Java source with comprehensive IntelliJ support.
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,729 | 🐛 63 | 🌐 Go | 📅 2026-09-23 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,357 | 🐛 89 | 🌐 Python | 📅 2026-09-21 - DuckDB dbt adapter.
* [SQLFlow](https://github.com/turbolytics/sql-flow) ⭐ 799 | 🐛 80 | 🌐 Go | 📅 2026-09-23 - Enables SQL-based stream processing, powered by DuckDB.
...
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 125 | 🐛 2 | 🌐 Python | 📅 2026-09-22 - A semantic layer with DuckDB integration.
* [OrionBelt Semantic Layer](https://github.com/ralfbecher/orionbelt-semantic-layer) ⭐ 98 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Open-source semantic sidecar that compiles YAML semantic models to optimized SQL across 8 engines including DuckDB. Ships with an `ob-duckdb` driver, REST + Arrow Flight SQL + Postgres wire surfaces, and a baked-in DuckDB quickstart on Colab.
...
* [Scherlok](https://github.com/rbmuller/scherlok) ⭐ 9 | 🐛 13 | 🌐 Python | 📅 2026-09-23 - Data quality monitoring CLI that profiles tables and detects anomalies (volume, freshness, schema drift, NULL rates, distributions) without configuration; DuckDB is one of its connectors and backs its built-in demo.
* [DuckDBExcelAddin](https://github.com/sonhn85/DuckDBExcelAddin) ⭐ 6 | 🐛 1 | 🌐 C | 📅 2026-09-23 - Native Excel XLL add-in for DuckDB with parameter binding, async execution and Excel range table functions.
* [omniload](https://github.com/panodata/omniload) ⭐ 5 | 🐛 42 | 🌐 Python | 📅 2026-09-23 - Polyglot data loader for ETL, warehousing and more, based on dlt. Supports 140+ source/destination adapters. Derived from ingestr v0 (MIT).
...
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,249 | 🐛 125 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,643 | 🐛 111 | 🌐 Python | 📅 2026-09-23 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,999 | 🐛 184 | 🌐 C++ | 📅 2026-09-22 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 439 | 🐛 81 | 🌐 C++ | 📅 2026-09-23 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 231 | 🐛 59 | 🌐 C++ | 📅 2026-09-23 - For Delta Lake support.
...
* [`avro`](https://github.com/duckdb/duckdb-avro) ⭐ 35 | 🐛 8 | 🌐 C++ | 📅 2026-09-23 - For reading Avro files.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 498 | 🐛 32 | 🌐 C++ | 📅 2026-09-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`bigquery`](https://github.com/hafenkran/duckdb-bigquery) ⭐ 171 | 🐛 8 | 🌐 C++ | 📅 2026-09-23 - Integrates DuckDB with Google BigQuery, allowing direct querying and management of BigQuery datasets.
...
* [`netquack`](https://github.com/hatamiarash7/duckdb-netquack) ⭐ 44 | 🐛 2 | 🌐 C++ | 📅 2026-09-21 - Parsing, extracting, and analyzing domains, URIs, and paths with ease.
...
* [ERPL Web](https://github.com/DataZooDE/erpl-web) ⭐ 31 | 🐛 7 | 🌐 C++ | 📅 2026-09-23 - ERPL Web is a DuckDB extension that connects API-based ecosystems via standard interfaces like OData, GraphQL, and REST.
