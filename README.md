...
* [DuckERD CLI](https://github.com/tobilg/duckerd) ⭐ 158 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-06 – A CLI tool to create an ER Diagram from DuckDB database files.
...
* [Rust](https://github.com/duckdb/duckdb-rs) ⭐ 956 | 🐛 21 | 🌐 Rust | 📅 2026-08-19
* [.NET](https://github.com/Giorgi/DuckDB.NET/) ⭐ 695 | 🐛 25 | 🌐 C# | 📅 2026-08-15
* [Go](https://github.com/duckdb/duckdb-go) ⭐ 287 | 🐛 54 | 🌐 Go | 📅 2026-08-12
...
* [PHP (PDO)](https://github.com/thomas-0816/pdo-duckdb-php) ⭐ 8 | 🐛 0 | 🌐 PHP | 📅 2026-08-19
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,559 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - Python transpiler that translates between 24 different SQL dialects including DuckDB.
* [SQLMesh](https://github.com/TobikoData/sqlmesh) ⭐ 3,253 | 🐛 276 | 🌐 Python | 📅 2026-08-23 - A next-generation data transformation and modeling framework with support for DuckDB connections for state, transformations & running unit tests locally.
* [Spice.ai](https://github.com/spiceai/spiceai) ⭐ 3,069 | 🐛 644 | 🌐 Rust | 📅 2026-08-23 - A unified SQL query interface and portable runtime to locally materialize (using an embedded DuckDB), accelerate, and query datasets from any database, data warehouse, or data lake.
* [Rill Data](https://github.com/rilldata/rill) ⭐ 2,829 | 🐛 199 | 🌐 Go | 📅 2026-08-21 - Tool for effortlessly transforming data sets into powerful, opinionated dashboards using SQL.
* [Amphi ETL](https://github.com/amphi-ai/amphi-etl) ⭐ 1,398 | 🐛 128 | 🌐 TypeScript | 📅 2026-07-23 - Low-code data pipelines for structured and unstructured data. SQL transformations are powered by DuckDB.
* [Shaper](https://github.com/taleshape-com/shaper) ⭐ 1,236 | 🐛 26 | 🌐 Go | 📅 2026-08-21 - Open-source SQL-driven data dashboards, powering Taleshape, built on DuckDB.
* [Duckle](https://github.com/SouravRoy-ETL/duckle) ⭐ 1,223 | 🐛 73 | 🌐 Rust | 📅 2026-08-23 - Local-first visual ETL/ELT studio. Drag sources, transforms and sinks onto a canvas; it compiles to plain DuckDB SQL and runs entirely on DuckDB. Open source desktop app, with a built-in MCP server for generating and running pipelines from natural language.
* [Arc](https://github.com/Basekick-Labs/arc) ⭐ 667 | 🐛 48 | 🌐 Go | 📅 2026-08-22 - Time-series data warehouse built on DuckDB.
* [Huey](https://github.com/rpbouman/huey) ⭐ 610 | 🐛 111 | 🌐 JavaScript | 📅 2026-08-23 - Blazing-fast & intuitive pivot tables on Parquet, CSV, JSON files and DuckDB tables in the browser based on DuckDB-Wasm. open-source (MIT). Zero install!
...
* [ReportBurster](https://github.com/flowkraft/reportburster) ⭐ 76 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-16 - Business Intelligence Done Right - ReportBurster uses DuckDB as its in-process analytics database engine, and for larger workloads, supports ClickHouse too.
...
* [geol](https://github.com/opt-nc/geol) ⭐ 12 | 🐛 23 | 🌐 HTML | 📅 2026-08-23 - A command line tool to efficiently show end-of-life dates for a number of products in your terminal using the [`endoflife.date`](https://endoflife.date) API, makes it possible to export the whole `endoflife.date` database as a fully featured DuckDB file.
...
* [Pondview](https://github.com/paulmupeters/pondview-bi) ⭐ 1 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-20 - Open-source, DuckDB-powered BI workspace for AI-assisted analysis, SQL, charts, and dashboards.
...
* [Splink](http://github.com/moj-analytical-services/splink) ⭐ 2,355 | 🐛 226 | 🌐 Python | 📅 2026-08-21 - A free Python library for fast, accurate data deduplication and record linkage.
...
* [Narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,702 | 🐛 245 | 🌐 Python | 📅 2026-08-23 - Lightweight and extensible compatibility layer between dataframe libraries, supports DuckDB.
...
* [SQLFrame](https://github.com/eakmanrq/sqlframe) ⭐ 531 | 🐛 21 | 🌐 Python | 📅 2026-08-20 - Implements the PySpark DataFrame API in order to enable running transformation pipelines directly on database engines such as DuckDB.
...
* [Simple-data-analysis](https://github.com/nshiab/simple-data-analysis) ⭐ 356 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - Easy-to-use and high-performance JavaScript library for data analysis.
...
* [DuckDB.EFCoreProvider](https://github.com/skuirrels/DuckDB.EFCoreProvider) ⭐ 14 | 🐛 1 | 🌐 C# | 📅 2026-08-20 - Entity Framework Core provider for DuckDB and DuckLake, with LINQ, writes, migrations, bulk ingestion, and Parquet-backed tiered storage for .NET.
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,287 | 🐛 17 | 🌐 Rust | 📅 2026-08-23 - A database TUI with experimental support for DuckDB.
...
* [msgvault](https://github.com/wesm/msgvault) ⭐ 2,036 | 🐛 94 | 🌐 Go | 📅 2026-08-23 - Archive a lifetime of email and chat. Offline search, analytics, and AI query over your full message history. Powered by DuckDB.
...
* [`transfermarkt-datasets`](https://github.com/dcaribou/transfermarkt-datasets) ⭐ 478 | 🐛 51 | 🌐 Python | 📅 2026-08-05 - Curated football datasets from [Transfermarkt](https://www.transfermarkt.co.uk/).
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,637 | 🐛 2 | 🌐 Makefile | 📅 2026-08-21 - The platform for customizing AI from enterprise data. [MindsDB integrates with DuckDB](https://docs.mindsdb.com/integrations/data-integrations/duckdb), making data from DuckDB accessible to a diverse range of AI/ML models.
* [ingestr](https://github.com/bruin-data/ingestr) ⭐ 3,857 | 🐛 16 | 🌐 Go | 📅 2026-08-21 - CLI tool to copy data between databases and SaaS sources, with DuckDB supported as both a source and a destination.
...
* [Bruin](https://github.com/bruin-data/bruin) ⭐ 1,674 | 🐛 36 | 🌐 Go | 📅 2026-08-22 - Data pipeline CLI that runs SQL and Python transformations with built-in quality checks, using DuckDB as one of its supported platforms.
* [dbt-duckdb](https://github.com/jwills/dbt-duckdb) ⭐ 1,338 | 🐛 83 | 🌐 Python | 📅 2026-08-17 - DuckDB dbt adapter.
...
* [Sidemantic](https://github.com/sidequery/sidemantic) ⭐ 115 | 🐛 4 | 🌐 Python | 📅 2026-08-23 - A semantic layer with DuckDB integration.
* [duckdb-power-query-connector](https://github.com/MotherDuck-Open-Source/duckdb-power-query-connector) ⭐ 89 | 🐛 6 | 🌐 Power Query | 📅 2026-07-29 - DuckDB Power Query Custom Connector.
* [OrionBelt Semantic Layer](https://github.com/ralfbecher/orionbelt-semantic-layer) ⭐ 73 | 🐛 8 | 🌐 Python | 📅 2026-08-23 - Open-source semantic sidecar that compiles YAML semantic models to optimized SQL across 8 engines including DuckDB. Ships with an `ob-duckdb` driver, REST + Arrow Flight SQL + Postgres wire surfaces, and a baked-in DuckDB quickstart on Colab.
...
* [AliSQL](https://github.com/alibaba/AliSQL) ⭐ 5,870 | 🐛 17 | 🌐 C++ | 📅 2026-07-18 - A MySQL branch originated from Alibaba Group. Integrates DuckDB as a native storage engine.
* [pg\_duckdb](https://github.com/duckdb/pg_duckdb) ⭐ 3,204 | 🐛 117 | 🌐 C++ | 📅 2026-07-17 - DuckDB-powered PostgreSQL for high-performance apps & analytics.
...
* [pg\_lake](https://github.com/snowflake-labs/pg_lake) ⭐ 1,620 | 🐛 106 | 🌐 Python | 📅 2026-08-23 - `pg_lake` integrates Iceberg and data lake files into Postgres. Uses DuckDB to execute queries.
* [MyDuck Server](https://github.com/apecloud/myduckserver) ⭐ 582 | 🐛 37 | 🌐 Go | 📅 2026-08-23 - A server wrapping DuckDB with MySQL and PostgreSQL wire protocol support.
...
* [GizmoSQL - Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql) ⭐ 357 | 🐛 1 | 🌐 C++ | 📅 2026-08-18 - A C++ implementation of the [Arrow Flight SQL protocol](https://arrow.apache.org/docs/format/FlightSql.html) that runs in a client-server setup with DuckDB or SQLite as backends.
...
* [`ducklake`](https://github.com/duckdb/ducklake) ⭐ 2,928 | 🐛 170 | 🌐 C++ | 📅 2026-08-20 - For DuckLake support.
* [`iceberg`](https://github.com/duckdb/duckdb_iceberg) ⭐ 428 | 🐛 89 | 🌐 C++ | 📅 2026-08-21 - For reading Iceberg tables.
* [`delta`](https://github.com/duckdb/duckdb_delta) ⭐ 228 | 🐛 60 | 🌐 C++ | 📅 2026-08-21 - For Delta Lake support.
...
* [`duckpgq`](https://github.com/cwida/duckpgq-extension) ⭐ 481 | 🐛 31 | 🌐 C++ | 📅 2026-08-17 - Add supports for SQL/PGQ (Property Graph Queries) introduced in the SQL:2023 standard.
...
* [`cache_httpfs`](https://github.com/dentiny/duck-read-cache-fs) ⭐ 145 | 🐛 13 | 🌐 C++ | 📅 2026-08-06 - Adds a read caching layer to duckdb filesystem to improve query performance and reduce egress cost.
* [`infera`](https://github.com/CogitatorTech/infera) ⭐ 135 | 🐛 5 | 🌐 Rust | 📅 2026-07-22 - A DuckDB extension for in-database inference.
* [`dash`](https://github.com/gropaul/dash) ⭐ 97 | 🐛 1 | 🌐 C++ | 📅 2026-08-13 - Fully local data canvas and dashboarding app within DuckDB.
...
* [DuckDB Extension Radar](https://github.com/mehd-io/duckdb-extension-radar) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - Repository that contains DuckDB extensions on GitHub. Refreshed daily.
